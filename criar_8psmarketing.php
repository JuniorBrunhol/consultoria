        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="8psmarketing.php">8Ps do Marketing Digital </a>/ Novo</li>
	...
	<div class="breadcomb-area">
		<div class="container">
			<div class="row">
              ...
              <form id="form" name="form" method="post" action="gravar_8psmarketing.php">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <input type="text" class="form-control" id="titulo_8psmarketing" name="titulo_8psmarketing" placeholder="Preencha um título para identificar seu 8ps do Marketing Digital"><br>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="pesquisa_8psmarketing" name="pesquisa_8psmarketing" rows="5" placeholder="A Pesquisa é responsável pelo estudo do perfil do consumidor e seu comportamento na internet. Entender as motivações, tendências e comportamentos é fundamental para conhecer e definir seu público-alvo e orientar as ações de marketing digital."></textarea>
        </div>
            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="propagacao_8psmarketing" name="propagacao_8psmarketing" rows="5" placeholder="No P da Propagação, é hora de viralizar suas campanhas. Já ouviu falar que o melhor marketing é o boca a boca, não é? Pois aqui a diferença é que esse boca a boca se tornou virtual."></textarea>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                      ...
                      <textarea type="text" class="form-control" id="resumo_8psmarketing" name="resumo_8psmarketing" rows="5" placeholder="Observações do Consultor"></textarea>
                      <br><br> 
                                         <a href="gravar_8psmarketing.php"><button class="btn btn-success success-icon-notika btn-reco-mg btn-button-mg">
         
        <i class="notika-icon notika-checked"><font face="arial" size="2">  Salvar  </font></i></button></a>
                                        <a href="8psmarketing.php"> <button class="btn btn-danger danger-icon-notika btn-reco-mg btn-button-mg" value="Input Button" onclick=" relocate_home1()">
