...
include_once 'conexao/conexao.php';
  ...
  $retorno = mysqli_query ($mysqli , $sql) or die (mysql_error());
   while ($lista = mysqli_fetch_assoc ($retorno)) {
    ...
    $idproposta = $lista['id_proposta'];
    $pronome = $lista['pronome_proposta'];
    $contato = $lista['contato_proposta'];
    $titulo = $lista['titulo_proposta'];
    $objeto = str_replace('<br />', "\n", $lista['objeto_proposta']);
    $objetivo = str_replace('<br />', "\n", $lista['objetivoespecifico_proposta']);
    $metodologia = str_replace('<br />', "\n", $lista['metodologia_proposta']);
    $equipe = str_replace('<br />', "\n", $lista['equipetecnica_proposta']);
    $prazo = str_replace('<br />', "\n", $lista['prazo_proposta']);
    $entregas = str_replace('<br />', "\n", $lista['entregas_proposta']);
    $preco = str_replace('<br />', "\n", $lista['preco_proposta']);
    $formapagamento = str_replace('<br />', "\n", $lista['formapagamento_proposta']);      
    $validade = str_replace('<br />', "\n", $lista['validade_proposta']);      
    $respcontratante = str_replace('<br />', "\n", $lista['responsabilidadecontratante_proposta']);      
    $respproponente = str_replace('<br />', "\n", $lista['responsabilidadeproponente_proposta']);      
    $confidencialidade = str_replace('<br />', "\n", $lista['confidencialidade_proposta']);     
    $conclusao = str_replace('<br />', "\n", $lista['conclusao_proposta']); 
...
<div class="subnavbar">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/  Clientes / <a href="propcons.php">Proposta de Consultoria </a>/ Editar</li>
         ...
         <form id="form" name="form" method="post" action="gravaredicao_propcons.php">  
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>OBJETIVO ESPECÍFICO  - O QUE SE ESPERA SER ALCANÇADO NO FINAL DO PROCESSO
                            </h2><br>
                            <div id="formulario">
                <div class="form-group">
                  
                    <textarea type="text" class="form-control" id="objetivo" name="objetivo"  required rows="10" placeholder="Descrever os objetivos secundários do trabalho, prezando por esclarecer itens/informações que serão alcançadas para o atingimento do objetivo geral."><?PHP echo $objetivo; ?> </textarea>
        </div>
            </div>
                        </div>
    ...
    <div class="data-table-area">
        <div class="container">
            <div class="row">
                ...
                <input type="hidden" class="form-control" id="id" name="id"  required placeholder="Deseja usar uma frase de efeito?" value="<?php echo $id; ?>">
  ...
  <br>
       ...
       {
            location.href = "gravaredicao_propcons.php?prop=<?php echo $idproposta; ?>";
       } 
