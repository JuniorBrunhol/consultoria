        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ Mapa da Empatia</li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            <p>O Mapa da Empatia é uma ferramenta, que ajuda a nos colocarmos no lugar dos clientes de um negócio. A ferramenta exercita reflexões sobre o que o cliente diz, faz, vê, pensa, sente e ouve para ajudar no desenho do modelo de negócio de uma empresa.</p>
                        </div>
...
{
     location.href = "criar_canvas.php";
} 
</script>Novo Mapa de Empatia</button><br><br>
                
                            <table id="data-table-basic" class="table table-striped"  width=100%>
                                <thead>
                                    <tr>
                                        <th>Título do Mapa da Empatia</th>
                                        <th>Criado em</th>
...
function relocate_home3()
{
     location.href = "editar_4ps.php";
                                ...
                                <tfoot>
                                    <tr>
                                        <th>Título da Mapa da Empatia</th>
                                        <th>Criado em</th>
