        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="canvas.php">Canvas </a>/ Novo</li>
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Canvas - Business Model Canvas</h2>
										<p>Criado em <i>10/06/2020</i> por <i>Junior Brunhol de Araujo</i></p>
									</div>
								</div>
							</div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Coloque um título para seu Canvas (Business Model Canvas): 
                            </h2><br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>SEGMENTO DE CLIENTES - Quem é o seu público? Qual seu nicho de atuação? 
                            </h2><br>
                            <div id="formulario">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>OFERTA DE VALOR - Quais são os benefícios de seu produto ou serviço? 
                            </h2><br>
                            <div id="formulario">
                <div class="form-group">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>CANAIS - Onde e como será ofertado o produto ou serviço? 
                            </h2><br>
                            <div id="formulario">
                <div class="form-group">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>RELACIONAMENTO - Quais as estratégias utilizadas para fidelizar clientes? 
                                </h2>    <br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>FONTES DE RENDA - Como o negócio será rentabilizado? 
                                </h2>    <br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>RECURSOS CHAVE - O que é essencial para fazer o negócio funcionar? 
                                </h2>    <br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>ATIVIDADES CHAVE - Qual o CORE Business da empresa? 
                                </h2>    <br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>PARCERIAS CHAVES - Quem serão os fornecedores e terceirizados do negócio? 
                                </h2>    <br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>ESTRUTURA DE CUSTOS - Quais serão os custos fixos e variáveis deste novo negócio? 
                                </h2>    <br>
