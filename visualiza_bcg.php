        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="bcg.php">Matriz BCG </a>/ Visualizar</li>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Matriz BCG</h2>
										<p>Criado em <i><?php echo date('d/m/Y',  strtotime($data_bcg)); ?></p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
								<div class="breadcomb-report">
                <a href="editar_bcg.php?id=<?php echo $id_bcg; ?>">	<button data-toggle="tooltip" data-placement="left" title="Editar Matriz BCG" class="btn" ><i class="notika-icon notika-left-arrow"></i></button></a>
                <a href="pdf-visualiza_bcg.php?id=<?php echo $id_bcg;?>">	<button data-toggle="tooltip" data-placement="left" title="Download Matriz BCG" class="btn"><i class="notika-icon notika-sent"></i></button></a>
								</div>
							</div>
						</div>
					</div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Título: <?php echo $titulo_bcg; ?></h2>
                            <p><strong>Observações do Consultor: </strong><?php echo $resumo_bcg; ?></p>
                    ...
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            <tr>
                                ...
                                <td bgcolor="#c9c9c9" colspan="2" id="minhatabela"><h3>Participação Relativa de Mercado</h3></td>
                               
                             </tr>
                             <tr>
                             <td bgcolor="#ececec" id="minhatabela"><h5>Alta</h5></td>
                             <td bgcolor="#ececec" id="minhatabela"><h5>Baixa</h5></td>
                               
                             </tr>
                             <tr>
                             <td id="minhatabela" bgcolor="#c9c9c9" rowspan="2" ><h3>Crescimento do Mercado</h3></td>
                                <td bgcolor="#ececec"  width=10%><h5>Alta</h5></td>
                                <td bgcolor="#f6c285" width=35% id="minhatabela2"><?php echo $estrela_bcg; ?></td>
                                <td bgcolor="#ede48f" width=35% id="minhatabela2"><?php echo $questionamento_bcg; ?></td>
                             </tr>
                             <tr>
                            
                                <td bgcolor="#ececec" ><h5>Baixa</h5></td>
                                <td bgcolor="#f8dcdc" id="minhatabela2"><?php echo $vaca_bcg; ?></td>
                                <td bgcolor="#5fdbe2" id="minhatabela2"><?php echo $abacaxi_bcg; ?></td>
                             </tr>
