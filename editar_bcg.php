...
include_once 'conexao/conexao.php';
  ...
  $sql = "SELECT * FROM `bcg` WHERE (`id_bcg` =  '".$id."') "; 
  $retorno = mysqli_query ($mysqli , $sql) or die (mysql_error());
   while ($lista = mysqli_fetch_assoc ($retorno)) {
    $id_bcg = $lista['id_bcg'];
    $titulo_bcg = $lista['titulo_bcg'];
    $estrela_bcg = str_replace('<br />', "\n", $lista['estrela_bcg']);
    $questionamento_bcg = str_replace('<br />', "\n", $lista['questionamento_bcg']);
    $vaca_bcg = str_replace('<br />', "\n", $lista['vaca_bcg']);
    $abacaxi_bcg = str_replace('<br />', "\n", $lista['abacaxi_bcg']);
    $resumo_bcg = str_replace('<br />', "\n", $lista['resumo_bcg']);
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="bcg.php">Matriz BCG </a>/ Editar</li>
	...
	<div class="breadcomb-area">
		<div class="container">
			<div class="row">
              ...
              <form id="form" name="form" method="post" action="gravaredicao_bcg.php">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            <input type="hidden" class="form-control" id="id_bcg" name="id_bcg"  value="<?php echo $id; ?>"><br>
  
                    <input type="text" class="form-control" id="titulo_bcg" name="titulo_bcg" placeholder="Preencha um título para identificar sua Matriz bcg" value="<?php echo $titulo_bcg; ?>"><br>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="vaca_bcg" name="vaca_bcg" rows="10" placeholder="Os lucros e a geração de caixa são altos. Como o crescimento do mercado é baixo, não são necessários grandes investimentos. Pode ser a base de uma empresa, já que a empresa detém uma quota de mercado considerável."><?php echo $vaca_bcg; ?></textarea>
        </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                      ...
                      <textarea type="text" class="form-control" id="resumo_bcg" name="resumo_bcg" rows="5" placeholder="Observações do Consultor"><?php echo $resumo_bcg; ?></textarea>
                      <br><br> 
                                         <a href="gravaredicao_bcg.php"><button class="btn btn-success success-icon-notika btn-reco-mg btn-button-mg">
