        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="planodetrabalho.php">Plano de Trabalho </a>/ Editar Ações</li>
        ...
        <div class="container">
         <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
           ...
           <?php   $sql1 = "SELECT * FROM `cronograma` WHERE (`id_cronograma` = '".$cronograma."') "; 
    $retorno1 = mysqli_query ($mysqli , $sql1) or die (mysql_error());
    while($dados1 = mysqli_fetch_array($retorno1)){
    $id_cronograma = $dados1['id_cronograma'];
    $datainicial_cronograma = $dados1['datainicial_cronograma'];
    $previsaofim_cronograma = $dados1['previsaofim_cronograma'];
    $titulo_cronograma = $dados1['titulo_cronograma'];
    $atingimento_cronograma = $dados1['atingimento_cronograma'];
    $objetivo_cronograma = $dados1['objetivo_cronograma'];
    }
    ?>
...
<br>
                  <div class="col-lg-12 col-md-3 col-sm-3 col-xs-12">
                    ...
                    <label> - ATINGIMENTO:</label> <?php echo $atingimento_cronograma;?>%
                    </div>
                  <br>
...
<br><Br>
        ...
        <form id="form" name="form" method="post" action="gravaredicao_acoesplanodetrabalho.php">
     	
        <div class="container">
         <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
           <div class="data-table-list">
           <h2>AÇÕES DO PLANO DE TRABALHO</h2><BR>
           <?php   $sql2 = "SELECT * FROM `acaocronograma` WHERE (`id_acaocronograma` = '".$id."') "; 
    $retorno2 = mysqli_query ($mysqli , $sql2) or die (mysql_error());
    while($dados2 = mysqli_fetch_array($retorno2)){
    $id_acaocronograma2 = $dados2['id_acaocronograma'];
    $tarefa_acaocronograma2 = $dados2['tarefa_acaocronograma'];
    $descricao_acaocronograma2 = $dados2['descricao_acaocronograma'];
    $dataprevisao_acaocronograma2 = $dados2['dataprevisao_acaocronograma'];
    $peso_acaocronograma2 = $dados2['peso_acaocronograma'];
    $dono_acaocronograma2 = $dados2['dono_acaocronograma'];
    $peso_acaocronograma2 = $peso_acaocronograma2;
    }
    ?>
                  <div class="input-group">
                    <span class="input-group-addon nk-ic-st-pro">BLOCO / TAREFA:</span> 
                    <div class="nk-int-st">
                    <input type="text" class="form-control" id="tarefa_acaocronograma" name="tarefa_acaocronograma" placeholder="Preencha com a tarefa do Plano de Trabalho" value="<?php echo $tarefa_acaocronograma2; ?>"><br>
                    <input type="hidden" class="form-control" id="idacaocronograma_acaocronograma" name="idacaocronograma_acaocronograma" placeholder="Preencha com a tarefa do Plano de Trabalho" value="<?php echo $id_acaocronograma2; ?>"><br>
                    <input type="hidden" class="form-control" id="peso2_acaocronograma" name="peso2_acaocronograma" placeholder="Preencha com a tarefa do Plano de Trabalho" value="<?php echo $peso2_acaocronograma; ?>"><br>
                    <input type="hidden" class="form-control" id="cronograma" name="cronograma" placeholder="Preencha com a tarefa do Plano de Trabalho" value="<?php echo $cronograma; ?>"><br>
                  ...
                  <div class="input-group">
                    <span class="input-group-addon nk-ic-st-pro">DESCRIÇÃO DA TAREFA:</span> 
                    <div class="nk-int-st">
                    <textarea type="text" class="form-control" id="descricao_acaocronograma" name="descricao_acaocronograma" rows="6"  required placeholder="Descreva como deve ser feito essa tarefa"><?php echo $descricao_acaocronograma2; ?></textarea>
                    </div>
                  </div>
                  <br>
                  ...
                  <div class="input-group">
                    ...
                    <div class="nk-int-st">
                    <input type="text" class="form-control" id="dataprevisao_acaocronograma" oninput="mascara(this, 'nascimento')" name="dataprevisao_acaocronograma"  required placeholder="Preencha a data de previsão" value="<?php echo date('d/m/Y',  strtotime($dataprevisao_acaocronograma2)); ?>"><br>
                    </div>
                    <span class="input-group-addon nk-ic-st-pro">RESPONSÁVEL:</span> 
                    <div class="nk-int-st">
                    <input type="text" class="form-control" id="dono_acaocronograma"  name="dono_acaocronograma"  required placeholder="Preencha o nome do Responsável" value="<?php echo $dono_acaocronograma2; ?>"><br>
                    </div>
                    <span class="input-group-addon nk-ic-st-pro">PESO:</span> 
                    <div class="nk-int-st">
                    
                                    <select id="peso_acaocronograma" class="form-control" name="peso_acaocronograma"> 
                                    <option value="<?php echo $peso_acaocronograma2; ?>" checked><?php 
                                    
                                    if($peso_acaocronograma2 == 1){
                                      echo 'Baixa Complexidade';
                                    }
                                    if($peso_acaocronograma2 == 2){
                                      echo 'Média Complexidade';
                                    }
                                    if($peso_acaocronograma2 == 3){
                  ...
                  <div class="input-group">
                    <br><br>
                    <a href="gravaredicao_acoesplanodetrabalho.php"><button class="btn btn-success success-icon-notika btn-reco-mg btn-button-mg"><i class="notika-icon notika-checked"><font face="arial" size="2">  Salvar  </font></i></button></a>
                    <a href="criar_acoesplanodetrabalho.php"> <button class="btn btn-danger danger-icon-notika btn-reco-mg btn-button-mg" value="Input Button" onclick=" relocate_home1()"><i class="notika-icon notika-close"><font face="arial" size="2">  Cancelar  </font></i></button></a>
                    <br><br>
                    </form>
                    </div>
                  </div>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th width=110 align="center">Peso</th>
    ...
    while($dados4 = mysqli_fetch_array($retorno4)){
      ...
      $idfinal_acaocronograma = str_replace('<br />', "\n", $dados4['id_acaocronograma']);
    ...
    ?>
                                    <tr>
                                        ...
                                        <td align="center"><?php echo $aproveitamento_acaocronograma; ?>%</td>
                                        <td align="center"><?php echo $dono_acaocronograma; ?></td>
                                      
                                        <td align="center"><a href="editar_acoesplanodetrabalho.php?id=<?php echo $idfinal_acaocronograma; ?>&cronograma=<?php echo $cronograma; ?>"><button type="button" class="btn btn-danger btn-sm">Editar</button></a></td>
                                        <td align="center"><a href="apagar_acaocronograma.php?id=<?php echo $idfinal_acaocronograma; ?>"><button type="button" class="btn btn-warning btn-sm">Excluir</button></a></td>
