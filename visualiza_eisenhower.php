        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="eisenhower.php">Matriz de Eisenhower </a>/ Visualizar</li>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										...
										<p>Criado em <i><?php echo date('d/m/Y',  strtotime($data_eisenhower)); ?></p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
								<div class="breadcomb-report">
                <a href="editar_eisenhower.php?id=<?php echo $id_eisenhower; ?>">	<button data-toggle="tooltip" data-placement="left" title="Editar Matriz Eisenhower" class="btn" ><i class="notika-icon notika-left-arrow"></i></button></a>
                <a href="pdf-visualiza_eisenhower.php?id=<?php echo $id_eisenhower;?>">	<button data-toggle="tooltip" data-placement="left" title="Download Matriz Eisenhower" class="btn"><i class="notika-icon notika-sent"></i></button></a>
								</div>
							</div>
						</div>
					</div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Título: <?php echo $titulo_eisenhower; ?></h2>
                            <p><strong>Observações do Consultor: </strong><?php echo $resumo_eisenhower; ?></p>
                    ...
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            <tr>
                                ...
                                <td bgcolor="#c9c9c9" colspan="2" id="minhatabela"><h3>Urgência</h3></td>
                               
                             </tr>
                             <tr>
                             <td bgcolor="#ececec" id="minhatabela"><h5>É importante, mas não urgente</h5></td>
                             <td bgcolor="#ececec" id="minhatabela"><h5>É importante e urgente</h5></td>
                               
                             </tr>
                             <tr>
                             <td id="minhatabela" bgcolor="#c9c9c9" rowspan="2" ><h3>Importância</h3></td>
                                <td bgcolor="#ececec"  width=10%><h5>É importante, mas não urgente</h5></td>
                                <td bgcolor="#f6c285" width=35% id="minhatabela2"><?php echo $programe_eisenhower; ?></td>
                                <td bgcolor="#ede48f" width=35% id="minhatabela2"><?php echo $faca_eisenhower; ?></td>
                             </tr>
                             <tr>
                            
                                <td bgcolor="#ececec" ><h5>É importante e urgente</h5></td>
                                <td bgcolor="#f8dcdc" id="minhatabela2"><?php echo $elimine_eisenhower; ?></td>
                                <td bgcolor="#5fdbe2" id="minhatabela2"><?php echo $delegue_eisenhower; ?></td>
                             </tr>
