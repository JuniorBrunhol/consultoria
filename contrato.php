                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            <p>Todo trabalho de consultoria deve possuir um contrato que respalde todo o serviço que está sendo executado.</p>
                        </div>
                        <a href = "criar_contrato.php"><div class="table-responsive"> <button type="button" class="btn btn-primary btn-lg">
Novo Contrato</button></a><br><br>
                            ...
                            <table id="data-table-basic" class="table table-striped" width=100%>
                                <thead>
                                    ...
                                    <tr><th width=60%>Contratos emitidos para este cliente</th>
                                        ...
                                        <th width=10% align="center">Registrado</th>
                                    </tr>
                                </thead>
                                <tbody>
                         <?php      
                          $sql3 = "SELECT * FROM `contrato` WHERE (`consultoria_contrato` = '".$consultoria_usuarios."') AND (`empresa_contrato` = '".$EmpresaID."') "; 
    $retorno3 = mysqli_query ($mysqli , $sql3) or die (mysql_error());
    while($dados3 = mysqli_fetch_array($retorno3)){
    $id_consultacontrato = $dados3['id_contrato'];
    $data_consultacontrato = $dados3['data_contrato'];
    $titulopagina_consultacontrato = $dados3['titulopagina_contrato'];
  
?>
                                    <tr>
                                        <td><div id="espaco"><?php echo $titulopagina_consultacontrato; ?></div></td>
                                        <td><?php echo date('d/m/Y',  strtotime($data_consultacontrato)); ?></td>
                                        
                                        <td><a href="visualiza_contrato.php?id=<?php echo $id_consultacontrato; ?>"><button type="button" class="btn btn-success btn-sm">Visualizar</button>
                                      
                                      </a>
                                    </td>
                                  
                                        <td><a href="editar_contrato.php?id=<?php echo $id_consultacontrato; ?>"><button type="button" class="btn btn-warning btn-sm"  value="Input Button">Editar</button></a></td>
