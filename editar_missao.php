        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="missao.php">Missão, visão e valores </a>/ Visualizar</li>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <p>Criado em 16/03/2022 por <i>Junior Brunhol de Araujo.</i></p>
									</div>
								</div>
							</div>
              ...
              <button type="button" class="btn btn-warning warning-icon-notika btn-reco-mg btn-button-mg" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Enquanto o propósito inspira e move pessoas, a missão descreve o negócio e a visão evidencia o patamar que a empresa quer alcançar. Já, os valores organizacionais, direcionam o comportamento e as atitudes dos profissionais da empresa.">  <i class="far fa-lightbulb"><font face="arial" size="2">  Ajuda  </font></i></button>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Coloque um título para sua Ferramenta de Missão, Visão e Valores: 
                            </h2><br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>MISSÃO - É o propósito de a empresa existir. É sua razão de ser. 
                            </h2><br>
                            <div id="formulario">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>VISÃO - É a situação em que a empresa deseja chegar (em período definido de tempo). 
                            </h2><br>
                            <div id="formulario">
                <div class="form-group">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>VALORES - Quais são os princípios que regem a empresa e que possibilitarão que a visão se realize? 
                            </h2><br>
                            <div id="formulario">
                <div class="form-group">
