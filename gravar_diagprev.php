...
$sql = "INSERT INTO diagprev (
 consultoria_diagprev,
empresa_diagprev,
titulo_diagprev,
data_diagprev,
contato_diagprev,
...
industria_diagprev,
servico_diagprev,
qtdefuncionariosatual_diagprev,
qtdefuncionariospico_diagprev,
porte_diagprev,
areaconstruida_diagprev,
marca_diagprev,
origemreceita_diagprev,
custosfixos_diagprev,
custosvariaveis_diagprev,
margemlucro_diagprev,
individamento_diagprev,
faturamento_diagprev,
sazonalidade_diagprev,
publicoalvo_diagprev,
concorrentes_diagprev,
corebusiness_diagprev,
publicidade_diagprev,
midiassociais_diagprev,
ecommerce_diagprev,
folhapagamento_diagprev,
tempomedio_diagprev,
liderancacomum_diagprev,
turnover_diagprev,
clima_diagprev,
recrutamento_diagprev,
horasextras_diagprev,
legalizacao_diagprev,
logistica_diagprev,
estoque_diagprev,
armazenagem_diagprev,
processos_diagprev,
tempomediofornecedor_diagprev,
tempomediocliente_diagprev,
frota_diagprev,
equipamentos_diagprev,
licencas_diagprev,
erp_diagprev,
nivelsenha_diagprev,
lgpd_diagprev,
sistemasuporte_diagprev,
crm_diagprev,
parceriascomerciais_diagprev,
parceriassociais_diagprev,
terceirizados_diagprev,
programassociais_diagprev,
sac_diagprev,
desafiosinternos_diagprev,
desafiosexternos_diagprev,
rivalidadeconcorrentes_diagprev,
processos2_diagprev,
rotinas_diagprev,
reunioes_diagprev,
kpisestabelecidos_diagprev,
metascurto_diagprev,
metasmedio_diagprev,
metaslongo_diagprev,
avaliacaoconsultor_diagprev ) VALUES (
...
'$metasmedio_diagprev',
'$metaslongo_diagprev',
'$avaliacaoconsultor_diagprev')";
      $resultado_usuario = mysqli_query($mysqli, $sql)or die(mysqli_error($mysqli));

      $sql2 = "SELECT MAX(id_diagprev) AS id_diagprev FROM `diagprev` WHERE (`empresa_diagprev` = '".$EmpresaID."') AND  (`consultoria_diagprev` = '".$consultoria_usuarios."') "; 
      $retorno2 = mysqli_query ($mysqli , $sql2) or die (mysql_error());
      while($dados2 = mysqli_fetch_array($retorno2)){
          $id = $dados2['id_diagprev'];
    header("Location:visualiza_diagprev.php?id=$id"); exit;
