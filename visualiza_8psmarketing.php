        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="8psmarketing.php">8ps do Marketing</a>/ Visualizar</li>
							...
							<div class="col-lg-10 col-md-9 col-sm-9 col-xs-9">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Visualizar 8ps do Marketing</h2>
										<p>Criado em <i><?php echo date('d/m/Y',  strtotime($data_8psmarketing)); ?></i> .</p>
									</div>
								</div>
							</div>
							<div class="col-lg-2 col-md-3 col-sm-3 col-xs-3">
              <a href="editar_8psmarketing.php?id=<?php echo $id_8psmarketing; ?>">	<button data-toggle="tooltip" data-placement="left" title="Editar 8ps do Marketing Digital" class="btn" ><i class="notika-icon notika-left-arrow"></i></button></a>
                <a href="pdf-visualiza_8psmarketing.php?id=<?php echo $id_8psmarketing; ?>">	<button data-toggle="tooltip" data-placement="left" title="Download 8ps do Marketing Digital" class="btn"><i class="notika-icon notika-sent"></i></button></a>
										</div>
						</div>
					</div>
				</div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $pesquisa_8psmarketing; ?>
                            <div id="formulario">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $planejamento_8psmarketing; ?>
                            <div id="formulario">
                <div class="form-group">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $producao_8psmarketing; ?>
                            <div id="formulario">
                <div class="form-group">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $publicacao_8psmarketing; ?>
                            <div id="formulario">
                <div class="form-group">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $promocao_8psmarketing; ?>
                            <div id="formulario">
                <div class="form-group">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $propagacao_8psmarketing; ?>
                            <div id="formulario">
                <div class="form-group">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $personalizacao_8psmarketing; ?>
                            <div id="formulario">
                <div class="form-group">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $precisao_8psmarketing; ?>
                            <div id="formulario">
                <div class="form-group">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $resumo_8psmarketing; ?>
                            <div id="formulario">
                <div class="form-group">
