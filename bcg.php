        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ Matriz BCG</li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Matriz BCG</h2>
                            <p>A Matriz BCG é uma análise gráfica desenvolvida por Bruce Henderson para a empresa de consultoria empresarial americana Boston Consulting Group em 1970. Seu objetivo é suportar a análise de portfólio de produtos ou de unidades de negócio baseado no conceito de ciclo de vida do produto. Ela é utilizada para alocar recursos em atividades de gestão de marcas e produtos (marketing), planejamento estratégico e análise de portfólio. Esta matriz é uma das formas mais usuais de representação do posicionamento de produtos ou unidades estratégicas de negócio da empresa em relação a variáveis externas e internas.</p>
                        </div>
                        <div class="table-responsive"> <a href="criar_bcg.php"> <button type="button" class="btn btn-primary btn-lg">
Nova Matriz BCG</button></a><br><br>
                
                            <table id="data-table-basic" class="table table-striped">
                                <thead>
                                    <tr>
                                        <th>Título da Matriz BCG</th>
                                        <th>Criado em</th>
                                ...
                                <tbody>
                             <?php   $sql3 = "SELECT * FROM `bcg` WHERE (`consultoria_bcg` = '".$consultoria_usuarios."') AND (`empresa_bcg` = '".$EmpresaID."') "; 
    $retorno3 = mysqli_query ($mysqli , $sql3) or die (mysql_error());
    while($dados3 = mysqli_fetch_array($retorno3)){
    $id_bcg = $dados3['id_bcg'];
    $data_bcg = $dados3['data_bcg'];
    $titulo_bcg = $dados3['titulo_bcg'];
   
    ?>
                                    <tr>
                                        <td><div id="espaco"><?php echo $titulo_bcg; ?></div></td>
                                        <td><?php echo date('d/m/Y',  strtotime($data_bcg)); ?></td>
                                      
                                        <td><a href="visualiza_bcg.php?id=<?php echo $id_bcg; ?>"><button type="button" class="btn btn-success btn-sm"  value="Input Button">Visualizar</button>
                                      </a>
                                    </td>
                                        <td><a href="editar_bcg.php?id=<?php echo $id_bcg; ?>"><button type="button" class="btn btn-danger btn-sm">Editar</button></a></td>
                                        <td><a href="apagar_bcg.php?id=<?php echo $id_bcg; ?>"><button type="button" class="btn btn-warning btn-sm">Excluir</button></a></td>
