        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ Plano de Trabalho</li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            <p>O plano de trabalho é o escopo de todo o trabalho a ser executado e que deve ser enviado ap Cliente para aprovação. Nele está escrito os blocos de tarefas que depois servirão de base para o plano de ação.</p>
                        </div>
                        <div class="table-responsive"> <a href="criar_planodetrabalho.php"> <button type="button" class="btn btn-primary btn-lg">
Novo Plano de Trabalho</button></a><br><br>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th width=100>Prev.Término</th>
                                        <th width=80>Atingimento</th>
                                        <th width=50>Etapas</th>
    ...
    ?>
                                    <tr>
                                        ...
                                        <td align="center"><?php echo date('d/m/Y',  strtotime($previsaofim_cronograma)); ?></td>
                                        <td align="center"><?php 
                                        
                                        $sql19 = "SELECT count(cronograma_tarefa) AS total19 FROM tarefa WHERE (`cronograma_tarefa` = '".$id_cronograma."')";
            $retorno19 = mysqli_query($mysqli,$sql19);
            $values19 = mysqli_fetch_assoc($retorno19);
            $num_rows19=$values19['total19'];
                               
            $sql29 = "SELECT count(cronograma_tarefa) AS total29 FROM tarefa WHERE (`cronograma_tarefa` = '".$id_cronograma."') AND (`status_tarefa` = 'CONCLUÍDO')";
            ...
            $percentual = ($num_rows29/$num_rows19)*100;
          }
                                  echo $percentual;  
                                        ...
                                        ?>%</td>
                                        <td align="center"><a href="criar_acoesplanodetrabalho.php?id=<?php echo $id_cronograma; ?>"><button type="button" class="btn btn-primary btn-sm"  value="Input Button">Visualizar</button></a></td>
                                        ...
                                        <td align="center"><a href="editar_planodetrabalho.php?id=<?php echo $id_cronograma; ?>"><button type="button" class="btn btn-danger btn-sm">Editar</button></a></td>
                                        <td align="center"><a href="apagar_cronograma.php?id=<?php echo $id_cronograma; ?>"><button type="button" class="btn btn-warning btn-sm">Excluir</button></a></td>
