        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/  Clientes / <a href="diagprev.php">Diagnóstico Situacional </a>/ Novo</li>
         ...
         <form id="form" name="form" method="post" action="gravar_diagsituc.php">  
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        ...
                        <h1>Diagnóstico Situacional</h1><br>    
                        <h2>Coloque um título em seu Diagnóstico Situacional: 
                            </h2><br>
                            
               
                    <input type="text" class="form-control" id="titulo_diagnosticosituacional" name="titulo_diagnosticosituacional"  required placeholder="Preencha o seu título">
            ...
            <div class="row">
                ...
                <div class="row">
                                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
                                        <label class="hrzn-fm">PARECER DO CONSULTOR:</label>
                                    </div>
                                    <div class="col-lg-10 col-md-7 col-sm-7 col-xs-12">
                                    
                                    <textarea type="text" class="form-control" id="texto_diagnosticosituacional" name="texto_diagnosticosituacional" rows="4"   placeholder="Qual a origem das receitas da empresa?"></textarea>
                                    <br><br>
                 <a href="gravar_diagsituc.php"> <button type=submit class="btn btn-success success-icon-notika btn-reco-mg btn-button-mg">
 <i class="notika-icon notika-checked"><font face="arial" size="2">  Salvar  </font></i></button></a>
 </form>    <a href="diagsituc.php">    <button class="btn btn-danger danger-icon-notika btn-reco-mg btn-button-mg" value="Input Button" onclick=" relocate_home1()">
