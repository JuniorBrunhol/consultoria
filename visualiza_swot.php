        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="swot.php">SWOT </a>/ Visualizar</li>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>SWOT</h2>
										<p>Criado em <i><?php echo date('d/m/Y',  strtotime($data_swot)); ?></p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
								<div class="breadcomb-report">
                <a href="editar_swot.php?id=<?php echo  $consulta;?>">	<button data-toggle="tooltip" data-placement="left" title="Editar SWOT" class="btn" ><i class="notika-icon notika-left-arrow"></i></button></a>
                <a href="pdf-visualiza_swot.php?id=<?php echo  $consulta;?>">	<button data-toggle="tooltip" data-placement="left" title="Download SWOT" class="btn"><i class="notika-icon notika-sent"></i></button></a>
								</div>
							</div>
						</div>
					</div>
        ...
        <div class="container">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Título: <?php echo $titulo_swot; ?></h2>
                            <p><strong>Observações do Consultor: </strong><?php echo $resultado_swot; ?></p>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <table width=100% id="minhatabela" border=1 border-collor=#000000>
                         
                            <tr>
                                <td id="minhatabela" rowspan="2" ><h1>SWOT</h1></td>
                                <td bgcolor="#ececec" width=35% id="minhatabela"><h1>Fatores Positivos</h1></td>
                                <td bgcolor="#ececec" width=35% id="minhatabela"><h1>Fatores Negativos</h1></td>
                             </tr>
                             <tr>
                               
                                <td bgcolor="#ececec" id="minhatabela"><p>Forças</p></td>
                                <td bgcolor="#ececec" id="minhatabela"><p>Fraquezas</p></td>
                             </tr>
                                <tr bgcolor="#ececec" >

                                <td ><h1>Fatores Internos</h1></td>
                               
                                <td bgcolor="#f6c285" id="minhatabela2">
                                <?php echo $forcas_swot; ?>
                                 
                                </td>
                                <td bgcolor="#ede48f" id="minhatabela2">
                                <?php echo $fraquezas_swot; ?>
                                </td>
                                </tr>

                                <tr bgcolor="#ececec">
                                <td id="minhatabela"><h1>Fatores Externos</h1></td>
                                <td bgcolor="#f8dcdc"id="minhatabela2">
                                <?php echo $oportunidades_swot; ?>
                                </td>
                                <td bgcolor="#5fdbe2" id="minhatabela2">
                                <?php echo $ameacas_swot; ?>
                                </td>
                                </tr>
                                <tr>
                                <td bgcolor="#ffffff"  id="minhatabela"><p>ANÁLISE SWOT</p></td>
                                <td bgcolor="#ececec"  id="minhatabela"><p>Oportunidades</p></td>
                                <td bgcolor="#ececec" id="minhatabela"><p>Ameaças</p></td>
                             </tr>
                            </table>
                        </div>
