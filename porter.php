        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ 5 Forças de Porter</li>
...
Nova 5 Forças de Porter</button></a><br><br>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                             <?php   $sql3 = "SELECT * FROM `porter` WHERE (`consultoria_porter` = '".$consultoria_usuarios."') AND (`empresa_porter` = '".$EmpresaID."') "; 
    $retorno3 = mysqli_query ($mysqli , $sql3) or die (mysql_error());
    while($dados3 = mysqli_fetch_array($retorno3)){
    $id_porter = $dados3['id_porter'];
    $data_porter = $dados3['data_porter'];
    $titulo_porter = $dados3['titulo_porter'];
   
    ?>
                                    <tr>
                                        <td><div id="espaco"><?php echo $titulo_porter; ?></div></td>
                                        <td><?php echo date('d/m/Y',  strtotime($data_porter)); ?></td>
                                      
                                        <td><a href="visualiza_porter.php?id=<?php echo $id_porter; ?>"><button type="button" class="btn btn-success btn-sm"  value="Input Button">Visualizar</button>
                                      </a>
                                    </td>
                                        <td><a href="editar_porter.php?id=<?php echo $id_porter; ?>"><button type="button" class="btn btn-danger btn-sm">Editar</button></a></td>
                                        <td><a href="apagar_porter.php?id=<?php echo $id_porter; ?>"><button type="button" class="btn btn-warning btn-sm">Excluir</button></a></td>
                                           
                                      </tr>
<?php  } ?>
                                </tbody>
                                <tfoot>
                                    <tr>Titulo de 5 Forças de Porter</th>
                                        <th>Criado em</th>
