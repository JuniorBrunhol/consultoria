        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ Missão, visão e valores</li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            <p>Missão, Visão e Valores são as partes de uma das mais importantes ferramentas de gestão que as empresas podem usar para definir a sua estratégia de negócio. É a partir da MVV que as empresas alinham seu propósito e promovem a reflexão sobre o presente e futuro do empreendimento.</p>
                        </div>
...
{
     location.href = "criar_missao.php";
} 
</script>Novo Missão, Visão e Valores</button><br><br>
                
                            <table id="data-table-basic" class="table table-striped"  width=100%>
                                <thead>
                                    <tr>
                                        <th>Título do Missão, visão e Valores</th>
                                        <th>Criado em</th>
