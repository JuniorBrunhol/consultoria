        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ Cliente / Registro de Reunião de Consultoria</li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Reunião de Consultoria</h2>
                            <p>Registre tudo o que acontece em suas reuniões de consultoria.</p>
                        </div>
                        <a href = "criar_novareuniao.php"><div class="table-responsive"> <button type="button" class="btn btn-primary btn-lg">
Novo Registro de Reunião</button></a><br><br>
                            ...
                            <table id="data-table-basic" class="table table-striped" width=100%>
                                <thead>
                                    ...
                                    <tr><th width=60%>Registro de reuniões</th>
                                ...
                                <tbody>
                         <?php      
                          $sql3 = "SELECT * FROM `reuniao` WHERE (`consultoria_reuniao` = '".$consultoria_usuarios."') AND (`empresa_reuniao` = '".$EmpresaID."') "; 
    $retorno3 = mysqli_query ($mysqli , $sql3) or die (mysql_error());
    while($dados3 = mysqli_fetch_array($retorno3)){
    $id_reuniao = $dados3['id_reuniao'];
    $datainicio_reuniao = $dados3['datainicio_reuniao'];
    $assunto_reuniao = $dados3['assunto_reuniao'];
   
    
  
?>
                                    <tr>
                                        <td><div id="espaco"><?php echo $assunto_reuniao; ?></div></td>
                                        <td><?php echo date('d/m/Y',  strtotime($datainicio_reuniao)); ?></td>
                                        
                                        <td><a href="visualiza_novareuniao.php?id=<?php echo $id_reuniao; ?>"><button type="button" class="btn btn-success btn-sm">Visualizar</button>
                                      
                                      </a>
                                    </td>
                                  
                                        <td><a href="editar_novareuniao.php?id=<?php echo $id_reuniao; ?>"><button type="button" class="btn btn-warning btn-sm"  value="Input Button">Editar</button></a></td>
                                        <td><a href="apagar_novareuniao.php?id=<?php echo $id_reuniao; ?>"><button type="button" class="btn btn-danger btn-sm">Excluir</button></td>
                                ...
                                <tfoot>
                                    <tr>
                                        <th>Contratos emitidos para este cliente</th>
