        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ KPIs (Indicadores)</li>
...
Novo KPI</button></a><br><br>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                             <?php   $sql3 = "SELECT * FROM `kpi` WHERE (`consultoria_kpi` = '".$consultoria_usuarios."') AND (`empresa_kpi` = '".$EmpresaID."') "; 
    $retorno3 = mysqli_query ($mysqli , $sql3) or die (mysql_error());
    ...
    ?>
                                    <tr>
                                        <td><div id="espaco"><?php echo $titulo_kpi; ?></div></td>
                                        <td><?php echo $frequencia_kpi; ?></td>
                                        <td><a href="cadastrar_dadoskpi.php?id=<?php echo $id_kpi; ?>"><button type="button" class="btn btn-success btn-sm" >Lançar Dados</button>
                                      </a>
             
                                        <td><a href="visualiza_kpi.php?id=<?php echo $id_kpi; ?>"><button type="button" class="btn btn-success btn-sm"  value="Input Button">Visualizar</button>
                                      </a>
                                    </td>
                                        <td><a href="editar_kpi.php?id=<?php echo $id_kpi; ?>"><button type="button" class="btn btn-danger btn-sm">Editar</button></a></td>
                                        <td><a href="apagar_kpi.php?id=<?php echo $id_kpi; ?>"><button type="button" class="btn btn-warning btn-sm">Excluir</button></a></td>
