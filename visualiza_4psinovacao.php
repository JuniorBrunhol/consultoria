        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="4psinovacao.php">4Ps da Inovação</a>/ Visualizar</li>
							...
							<div class="col-lg-10 col-md-9 col-sm-9 col-xs-9">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Visualizar 4Ps da Inovação</h2>
										<p>Criado em <i><?php echo date('d/m/Y',  strtotime($data_4psinovacao)); ?></i> .</p>
									</div>
								</div>
							</div>
							<div class="col-lg-2 col-md-3 col-sm-3 col-xs-3">
              <a href="editar_4psinovacao.php?id=<?php echo $id_4psinovacao; ?>">	<button data-toggle="tooltip" data-placement="left" title="Editar 4Ps da Inovacao" class="btn" ><i class="notika-icon notika-left-arrow"></i></button></a>
                <a href="pdf-visualiza_4psinovacao.php?id=<?php echo $id_4psinovacao;?>">	<button data-toggle="tooltip" data-placement="left" title="Download 4Ps da Inovacao" class="btn"><i class="notika-icon notika-sent"></i></button></a>
										</div>
						</div>
					</div>
				</div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $proposito_4psinovacao; ?>
                            <div id="formulario">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $processos_4psinovacao; ?>
                            <div id="formulario">
                <div class="form-group">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $pessoas_4psinovacao; ?>
                            <div id="formulario">
                <div class="form-group">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $politicas_4psinovacao; ?>
                            <div id="formulario">
                <div class="form-group">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $resumo_4psinovacao; ?>
                            <div id="formulario">
                <div class="form-group">
