        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ Matriz ANSOFF</li>
...
Nova Matriz ANSOFF</button></a><br><br>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                             <?php   $sql3 = "SELECT * FROM `ansoff` WHERE (`consultoria_ansoff` = '".$consultoria_usuarios."') AND (`empresa_ansoff` = '".$EmpresaID."') "; 
    $retorno3 = mysqli_query ($mysqli , $sql3) or die (mysql_error());
    while($dados3 = mysqli_fetch_array($retorno3)){
    $id_ansoff = $dados3['id_ansoff'];
    $data_ansoff = $dados3['data_ansoff'];
    $titulo_ansoff = $dados3['titulo_ansoff'];
   
    ?>
                                    <tr>
                                        <td><div id="espaco"><?php echo $titulo_ansoff; ?></div></td>
                                        <td><?php echo date('d/m/Y',  strtotime($data_ansoff)); ?></td>
                                      
                                        <td><a href="visualiza_ansoff.php?id=<?php echo $id_ansoff; ?>"><button type="button" class="btn btn-success btn-sm"  value="Input Button">Visualizar</button>
                                      </a>
                                    </td>
                                        <td><a href="editar_ansoff.php?id=<?php echo $id_ansoff; ?>"><button type="button" class="btn btn-danger btn-sm">Editar</button></a></td>
                                        <td><a href="apagar_ansoff.php?id=<?php echo $id_ansoff; ?>"><button type="button" class="btn btn-warning btn-sm">Excluir</button></a></td>
