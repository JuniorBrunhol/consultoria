							...
							<div class="col-lg-10 col-md-9 col-sm-9 col-xs-9">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Visualizar Registro de Reunião de Consultoria</h2>
										<p>Reunião realizada em <i><?php echo date('d/m/Y',  strtotime($datainicio_reuniao)); ?></i> .</p>
									</div>
								</div>
							</div>
							<div class="col-lg-2 col-md-3 col-sm-3 col-xs-3">
        		<a href="editar_novareuniao.php?id=<?php echo  $consulta;?>">	<button data-toggle="tooltip" data-placement="left" title="Editar Contrato" class="btn" ><i class="notika-icon notika-left-arrow"></i></button></a>
        
             <a href="pdf-visualiza_novareuniao.php?id=<?php echo  $consulta;?>"> <button data-toggle="tooltip" data-placement="left" title="Download arquivo" class="btn" value="Input Button" onclick=" relocate_home()"><i class="notika-icon notika-sent"></i></button></a>
							</div>
						</div>
					</div>
				</div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-11 col-md-7 col-sm-7 col-xs-12">
                         ...
                         <div class="col-lg-11 col-md-7 col-sm-7 col-xs-12">
                         <br><br>
                        <strong><h2> Registro de Reunião de Consultoria </h2> </strong>
    </div>        
    <div class="col-lg-11 col-md-7 col-sm-7 col-xs-12">
                        <br><br>     
                      ...
                      INÍCIO DA REUNIÃO: <?php echo date('d/m/Y H:m:s',  strtotime($datainicio_reuniao)); ?><br>
                      TÉRMINO DA REUNIÃO: <?php echo date('d/m/Y H:m:s',  strtotime($datatermino_reuniao)); ?><br>
                      DURAÇÃO: <?php echo $temporeuniao_reuniao; ?> minutos<br>
                      LOCAL DA REUNIÃO: <?php echo $local_reuniao; ?><br>
                      ÁREA / SETOR DA EMPRESA QUE FOI ATENDIDA: <?php echo $area_reuniao; ?><br>
                      ASSUNTO: <?php echo $assunto_reuniao; ?><br>
                      PARTICIPANTES: <?php echo $participantes_reuniao; ?><br><br>


   </div>
 
   <div class="col-lg-11 col-md-7 col-sm-7 col-xs-12">
<br><br><strong>FOLLOW´UP DAS ATIVIDADES DEIXADAS NA ÚLTIMA REUNIÃO:</strong><br><br>
 <font align-text="justify"><?php echo $follow_reuniao; ?></font>
<br><br>
...
<div class="col-lg-11 col-md-7 col-sm-7 col-xs-12">
<br><br><strong>AÇÕES DEIXADAS PARA EXECUÇÃO:</strong><br><br>
 <font align-text="justify"><?php echo $tarefas_reuniao; ?></font>
<br><br>
...
<div class="col-lg-11 col-md-7 col-sm-7 col-xs-12">
<br><br><strong>FERRAMENTAS DE GESTÃO UTILIZADAS DURANTE A REUNIÃO:</strong><br><br>
 <font align-text="justify"><?php echo $ferramentas_reuniao; ?></font>
<br><br>
...
<br><br><strong>RESUMO DA REUNIÃO:</strong><br><br>
 <font align-text="justify"><?php echo $resumo_reuniao; ?></font>
<br><br>

</div> 

<div class="col-lg-11 col-md-7 col-sm-7 col-xs-12">
<br><br><strong>PONTOS POSITIVOS DA REUNIÃO:</strong><br><br>
 <font align-text="justify"><?php echo $pontospositivos_reuniao; ?></font>
<br><br>

</div> 

<div class="col-lg-11 col-md-7 col-sm-7 col-xs-12">
<br><br><strong>PONTOS NEGATIVOS DA REUNIÃO:</strong><br><br>
 <font align-text="justify"><?php echo $pontosnegativos_reuniao; ?></font>
<br><br>
