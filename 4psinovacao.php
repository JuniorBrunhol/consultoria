        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ 4Ps da Inovação</li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>4Ps da Inovação</h2>
                            <p>Os 4Ps da inovação consistem em quatro áreas de decisões (propósito, processos, pessoas e políticas). É indicada para negócios de todos os portes, apesar desta ferramenta ter sido desenvolvida considerando pequenas e médias empresas.</p>
                        </div>
                        <div class="table-responsive"> <a href="criar_4psinovacao.php"> <button type="button" class="btn btn-primary btn-lg">
Nova 4Ps da Inovação</button></a><br><br>
                
                            <table id="data-table-basic" class="table table-striped">
                                <thead>
                                    <tr>
                                        <th>Título da 4Ps da Inovação</th>
                                        <th>Criado em</th>
                                ...
                                <tbody>
                             <?php   $sql3 = "SELECT * FROM `4psinovacao` WHERE (`consultoria_4psinovacao` = '".$consultoria_usuarios."') AND (`empresa_4psinovacao` = '".$EmpresaID."') "; 
    $retorno3 = mysqli_query ($mysqli , $sql3) or die (mysql_error());
    while($dados3 = mysqli_fetch_array($retorno3)){
    $id_4psinovacao = $dados3['id_4psinovacao'];
    $data_4psinovacao = $dados3['data_4psinovacao'];
    $titulo_4psinovacao = $dados3['titulo_4psinovacao'];
   
    ?>
                                    <tr>
                                        <td><div id="espaco"><?php echo $titulo_4psinovacao; ?></div></td>
                                        <td><?php echo date('d/m/Y',  strtotime($data_4psinovacao)); ?></td>
                                      
                                        <td><a href="visualiza_4psinovacao.php?id=<?php echo $id_4psinovacao; ?>"><button type="button" class="btn btn-success btn-sm"  value="Input Button">Visualizar</button>
                                      </a>
                                    </td>
                                        <td><a href="editar_4psinovacao.php?id=<?php echo $id_4psinovacao; ?>"><button type="button" class="btn btn-danger btn-sm">Editar</button></a></td>
                                        <td><a href="apagar_4psinovacao.php?id=<?php echo $id_4psinovacao; ?>"><button type="button" class="btn btn-warning btn-sm">Excluir</button></a></td>
...
<?php  } ?>
                                ...
                                <tfoot>
                                    <tr>
                                        <th>Título da 4ps da Inovacao</th>
                                        <th>Criado em</th>
