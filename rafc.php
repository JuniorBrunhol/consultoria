        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ Cliente / RAFC - Registro de Atividade Fora do Cliente</li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>RAFC - Registro de Atividade Fora do Cliente</h2>
                            <p>Registre tudo o que acontece nos momentos em que está trabalhando externamente ou no escritório.</p>
                        </div>
                        <a href = "criar_rafc.php"><div class="table-responsive"> <button type="button" class="btn btn-primary btn-lg">
Novo Registro de RAFC</button></a><br><br>
                            ...
                            <table id="data-table-basic" class="table table-striped" width=100%>
                                <thead>
                                    ...
                                    <tr><th width=60%>Registro de RAFC</th>
                                ...
                                <tbody>
                         <?php      
                          $sql3 = "SELECT * FROM `rafc` WHERE (`consultoria_rafc` = '".$consultoria_usuarios."') AND (`empresa_rafc` = '".$EmpresaID."') "; 
    $retorno3 = mysqli_query ($mysqli , $sql3) or die (mysql_error());
    while($dados3 = mysqli_fetch_array($retorno3)){
    $id_rafc = $dados3['id_rafc'];
    $datainicio_rafc = $dados3['datainicio_rafc'];
    $assunto_rafc = $dados3['assunto_rafc'];

    
  
?>
                                    <tr>
                                        <td><div id="espaco"><?php echo $assunto_rafc; ?></div></td>
                                        <td><?php echo date('d/m/Y',  strtotime($datainicio_rafc)); ?></td>
                                        
                                        <td><a href="visualiza_rafc.php?id=<?php echo $id_rafc; ?>"><button type="button" class="btn btn-success btn-sm">Visualizar</button>
                                      
                                      </a>
                                    </td>
                                  
                                        <td><a href="editar_rafc.php?id=<?php echo $id_rafc; ?>"><button type="button" class="btn btn-warning btn-sm"  value="Input Button">Editar</button></a></td>
