...
<div class="subnavbar">
  ...
  <!-- /subnavbar-inner --> 
    ...
    <div class="sale-statistic-area">
        <div class="container">
         ...
         <form id="form" name="form" method="post" action="gravar_cronogramareuniao.php">  
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                       ...
                       <div class="row">
                                    ...
                                    <input type="text" class="form-control" id="data_cronogramareuniao" oninput="mascara(this, 'nascimento')" name="data_cronogramareuniao"  required placeholder="Preencha a data inicial" value="<?php echo $datahoje; ?>"><br>
       ...
       <div class="row">
                                    ...
                                    <input type="text" class="form-control" id="titulo_cronogramareuniao" name="titulo_cronogramareuniao"  required placeholder="Título da reunião"><br>
                                 ...
                                 <div class="row">
                                    ...
                                    <textarea type="text" class="form-control" id="participantes_cronogramareuniao" name="participantes_cronogramareuniao" rows="3"  required placeholder="Quais são as pessoas que participaram desta reunião"></textarea>
  ...
  <div class="row">
                                    ...
                                    <textarea type="text" class="form-control" id="resumo_cronogramareuniao" name="resumo_cronogramareuniao" rows="6"  required placeholder="Escreva um breve resumo de tudo o que aconteceu durante a reunião"></textarea>
                                    <br><br>
                                         
                           
                                      
                                         <a href="gravar_cronogramareuniao.php"><button class="btn btn-success success-icon-notika btn-reco-mg btn-button-mg">
