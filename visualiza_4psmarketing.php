        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="4psmarketing.php">4Ps do Marketing</a>/ Visualizar</li>
							...
							<div class="col-lg-10 col-md-9 col-sm-9 col-xs-9">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Visualizar 4Ps do Marketing</h2>
										<p>Criado em <i><?php echo date('d/m/Y',  strtotime($data_4psmarketing)); ?></i> .</p>
									</div>
								</div>
							</div>
							<div class="col-lg-2 col-md-3 col-sm-3 col-xs-3">
              <a href="editar_4psmarketing.php?id=<?php echo $id_4psmarketing; ?>">	<button data-toggle="tooltip" data-placement="left" title="Editar 4Ps do Marketing" class="btn" ><i class="notika-icon notika-left-arrow"></i></button></a>
                <a href="pdf-visualiza_4psmarketing.php?id=<?php echo $id_4psmarketing;?>">	<button data-toggle="tooltip" data-placement="left" title="Download 4Ps do Marketing" class="btn"><i class="notika-icon notika-sent"></i></button></a>
										</div>
						</div>
					</div>
				</div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        ...
                        <h2>4PS O MARKETING</h2>
                        <label class="hrzn-fm">TÍTULO:</label>
                            
               
                  <?php echo $titulo_4psmarketing; ?>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $produto_4psmarketing; ?>
                            <div id="formulario">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $preco_4psmarketing; ?>
                            <div id="formulario">
                <div class="form-group">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $praca_4psmarketing; ?>
                            <div id="formulario">
                <div class="form-group">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $promocao_4psmarketing; ?>
                            <div id="formulario">
                <div class="form-group">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            </h2><?php echo $resumo_4psmarketing; ?>
                            <div id="formulario">
                <div class="form-group">
