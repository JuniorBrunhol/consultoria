	...
	<div class="breadcomb-area">
		<div class="container">
			<div class="row">
              ...
              <form id="form" name="form" method="post" action="gravar_swot.php">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="fraquezas_swot" name="fraquezas_swot" rows="10" placeholder="Quais são as fraquezas do negócio que a empresa precisa blindar?."></textarea>
        </div>
            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="forcas_swot" name="forcas_swot" rows="10" placeholder="Quais são as forças da empresa que ela precisa aproveitar?"></textarea>
        </div>
            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="ameacas_swot" name="ameacas_swot" rows="10" placeholder="Quais são as ameaças externas, no mercado, ambiente e outros que a empresa precisa estar atenta?."></textarea>
        </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="oportunidades_swot" name="oportunidades_swot" rows="10" placeholder="Quais são as oportunidades existentes que a empresa pode aproveitar para alavancar o negócio?"></textarea>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                      ...
                      <textarea type="text" class="form-control" id="resultado_swot" name="resultado_swot" rows="5" placeholder="Observações do Consultor"></textarea>
                      <br><br> 
