        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ Análise Pestel</li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            <p>A análise PEST é um acrónimo de análise Política, Económica, Social e Tecnológica" e consiste num enquadramento de fatores macroambientais usados como uma ferramenta na gestão estratégica de empresas. A análise PESTAL é uma ferramenta essencial para a análise da entrada de qualquer empresa no mercado ou na reanálise do posicionamento das existentes, e baseia-se na análise aos fatores externos à empresa que a podem influenciar, direta ou indiretamente. Trata-se pois de uma investigação com alguma profundidade, que se divide nas categorias acima referidas. Tais categorias ou fatores não se podem considerar como elementos estáticos, mas antes como forças dinâmicas, em contínua alteração, pelo que merecem igualmente um acompanhamento contínuo.O seu objetivo é fornecer um relatório relativo aos variados fatores macroambientais que devem ser tomados em consideração pela empresa. Trata-se de uma ferramenta estratégica útil para compreender o crescimento ou queda de mercados, posição e potencial comercial e orientação para operações. </p>
                        </div>
                        <div class="table-responsive"> <a href="criar_pestel.php"> <button type="button" class="btn btn-primary btn-lg">
Nova Análise Pestel</button></a><br><br>
                
                            <table id="data-table-basic" class="table table-striped">
                                <thead>
                                    <tr>
                                        <th>Título da Análise Pestel</th>
                                        <th>Criado em</th>
                                ...
                                <tbody>
                             <?php   $sql3 = "SELECT * FROM `pestel` WHERE (`consultoria_pestel` = '".$consultoria_usuarios."') AND (`empresa_pestel` = '".$EmpresaID."') "; 
    $retorno3 = mysqli_query ($mysqli , $sql3) or die (mysql_error());
    while($dados3 = mysqli_fetch_array($retorno3)){
    $id_pestel = $dados3['id_pestel'];
    $data_pestel = $dados3['data_pestel'];
    $titulo_pestel = $dados3['titulo_pestel'];
   
    ?>
                                    <tr>
                                        <td><div id="espaco"><?php echo $titulo_pestel; ?></div></td>
                                        <td><?php echo date('d/m/Y',  strtotime($data_pestel)); ?></td>
                                      
                                        <td><a href="visualiza_pestel.php?id=<?php echo $id_pestel; ?>"><button type="button" class="btn btn-success btn-sm"  value="Input Button">Visualizar</button>
                                      </a>
                                    </td>
                                        <td><a href="editar_pestel.php?id=<?php echo $id_pestel; ?>"><button type="button" class="btn btn-danger btn-sm">Editar</button></a></td>
                                        <td><a href="apagar_pestel.php?id=<?php echo $id_pestel; ?>"><button type="button" class="btn btn-warning btn-sm">Excluir</button></a></td>
