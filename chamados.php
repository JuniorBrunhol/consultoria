        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ Chamados</li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Chamados</h2>
                            <p>Abra um chamado sempre que sentir necessidade para melhoria do processo.</p>
                        </div>
                        <div class="table-responsive"> <a href="criar_chamados.php"> <button type="button" class="btn btn-primary btn-lg">
Novo Ticket</button></a><br><br>
                
                            <table id="data-table-basic" class="table table-striped">
                                <thead>
                                    <tr>
                                        <th width=350>Título do Ticket</th>
                                        <th width=50>Criado em</th>
                             ...
                             <?php   $sql3 = "SELECT * FROM `chamado` WHERE (`consultoria_chamado` = '".$consultoria_usuarios."') AND (`empresa_chamado` = '".$EmpresaID."') ORDER BY id_chamado DESC"; 
    $retorno3 = mysqli_query ($mysqli , $sql3) or die (mysql_error());
    while($dados3 = mysqli_fetch_array($retorno3)){
    $id_chamado = $dados3['id_chamado'];
    $dataabertura_chamado = $dados3['dataabertura_chamado'];
    $direcionamento_chamado = $dados3['direcionamento_chamado'];
    $status_chamado = $dados3['status_chamado'];
    $titulo_chamado = $dados3['titulo_chamado'];
    ?>
                                    <tr>
                                        <td><div id="espaco"><?php echo $titulo_chamado; ?></div></td>
                                        <td><?php echo date('d/m/Y',  strtotime($dataabertura_chamado)); ?></td>
                                      
                                        <td>
                                      <?php 
                                        $sql4 = "SELECT * FROM `usuarios` WHERE (`id_usuarios` = '".$direcionamento_chamado."') ORDER BY nome_usuarios"; 
    $retorno4 = mysqli_query ($mysqli , $sql4) or die (mysql_error());
      while ($lista4 = mysqli_fetch_array ($retorno4)) {
          ...
          $nome_usuarios = $lista4['nome_usuarios'];
           ...
           echo $nome_usuarios;  } ?>
                                        ...
                                        <td><?php echo $status_chamado; ?></td>
                                         <td><a href="visualiza_chamados.php?id=<?php echo $id_chamado; ?>"><button type="button" class="btn btn-warning btn-sm">Visualizar</button></a></td>
