        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ SWOT</li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Matriz SWOT</h2>
                            <p>Análise SWOT ou Análise FOFA é uma técnica de planejamento estratégico utilizada para auxiliar pessoas ou organizações a identificar forças, fraquezas, oportunidades, e ameaças relacionadas à competição em negócios ou planejamento de projetos.</p>
                        </div>
                        <div class="table-responsive"> <a href="criar_swot.php"> <button type="button" class="btn btn-primary btn-lg">
Novo SWOT</button></a><br><br>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                             <?php   $sql3 = "SELECT * FROM `swot` WHERE (`consultoria_swot` = '".$consultoria_usuarios."') AND (`empresa_swot` = '".$EmpresaID."') "; 
    $retorno3 = mysqli_query ($mysqli , $sql3) or die (mysql_error());
    while($dados3 = mysqli_fetch_array($retorno3)){
    $id_swot = $dados3['id_swot'];
    $data_swot = $dados3['data_swot'];
    $titulo_swot = $dados3['titulo_swot'];
   
    ?>
                                    <tr>
                                        <td><div id="espaco"><?php echo $titulo_swot; ?></div></td>
                                        <td><?php echo date('d/m/Y',  strtotime($data_swot)); ?></td>
                                      
                                        <td><a href="visualiza_swot.php?id=<?php echo $id_swot; ?>"><button type="button" class="btn btn-success btn-sm"  value="Input Button">Visualizar</button>
                                      </a>
                                    </td>
                                        <td><a href="editar_swot.php?id=<?php echo $id_swot; ?>"><button type="button" class="btn btn-danger btn-sm">Editar</button></a></td>
                                        <td><a href="apagar_swot.php?id=<?php echo $id_swot; ?>"><button type="button" class="btn btn-warning btn-sm">Excluir</button></a></td>
