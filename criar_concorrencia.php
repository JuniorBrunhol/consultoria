        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="concorrencia.php">Matriz de Concorrência </a>/ Novo</li>
...
{
     location.href = "gravar_concorrencia.php";
} 
...
{
     location.href = "concorrencia.php";
} 
