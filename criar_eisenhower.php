        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="eisenhower.php">Matriz de Eisenhower </a>/ Novo</li>
	...
	<div class="breadcomb-area">
		<div class="container">
			<div class="row">
              ...
              <form id="form" name="form" method="post" action="gravar_eisenhower.php">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <input type="text" class="form-control" id="titulo_eisenhower" name="titulo_eisenhower" placeholder="Preencha um título para identificar sua Matriz de Eisenhower"><br>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="programe_eisenhower" name="programe_eisenhower" rows="10" placeholder="boa para tarefas que devem ser desenvolvidas no médio ou longo prazo."></textarea>
        </div>
            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="faca_eisenhower" name="faca_eisenhower" rows="10" placeholder="Tarefa importante. Faça imediatamente."></textarea>
        </div>
            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="elimine_eisenhower" name="elimine_eisenhower" rows="10" placeholder="Gasto de energia desnecessário. Elimine essas tarefas de sua rotina."></textarea>
        </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="delegue_eisenhower" name="delegue_eisenhower" rows="10" placeholder="Tarefas que podem ser realizadas por outras pessoas. Delegue imediatamente."></textarea>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                      ...
                      <textarea type="text" class="form-control" id="resumo_eisenhower" name="resumo_eisenhower" rows="5" placeholder="Observações do Consultor"></textarea>
                      <br><br> 
                                         <a href="gravar_eisenhower.php"><button class="btn btn-success success-icon-notika btn-reco-mg btn-button-mg">
