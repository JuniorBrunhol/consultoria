        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ Cliente / <a href="cronogramareuniao.php">Cronograma de Reuniao</a>/ Visualizar</li>
							...
							<div class="col-lg-10 col-md-9 col-sm-9 col-xs-9">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Visualizar Cronograma de Reuniao</h2>
										<p>Atendimento a ser realizado em <i><?php echo date('d/m/Y',  strtotime($data_cronogramareuniao)); ?></i> .</p>
									</div>
								</div>
							</div>
							<div class="col-lg-2 col-md-3 col-sm-3 col-xs-3">
        		<a href="editar_cronogramareuniao.php?id=<?php echo $consulta;?>">	<button data-toggle="tooltip" data-placement="left" title="Editar cronogramareuniao" class="btn" ><i class="notika-icon notika-left-arrow"></i></button></a>
        
             <a href="pdf-visualiza_cronogramareuniao.php?id=<?php echo $consulta;?>"> <button data-toggle="tooltip" data-placement="left" title="Download arquivo cronogramareuniao" class="btn" value="Input Button" onclick=" relocate_home()"><i class="notika-icon notika-sent"></i></button></a>
							</div>
						</div>
					</div>
				</div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-11 col-md-7 col-sm-7 col-xs-12">
                         ...
                         <div class="col-lg-11 col-md-7 col-sm-7 col-xs-12">
                         <br><br>
                        <strong><h2> Cronograma de Reunião </h2> </strong>
    </div>        
    <div class="col-lg-11 col-md-7 col-sm-7 col-xs-12">
                        <br><br>     
                      ...
                      DIA PREVISTO PARA REUNIÃO:<?php echo date('d/m/Y',  strtotime($data_cronogramareuniao)); ?><br>
                      TÍTULO DA REUNIÃO: <?php echo $titulo_cronogramareuniao; ?><br>
                      PARTICIPANTES: <?php echo $participantes_cronogramareuniao; ?><br><br>
...
<br><br><strong>RESUMO DA REUNIÃO:</strong><br><br>
 <font align-text="justify"><?php echo $resumo_cronogramareuniao; ?></font>
<br><br>
