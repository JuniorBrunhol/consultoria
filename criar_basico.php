        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="basico.php">Matriz BÁSICO</a>/ Novo</li>
    ...
    <!-- Breadcomb area End-->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Coloque um título para sua Matriz BÁSICO: 
                            </h2><br>
        ...
        <div class="data-table-list">
            <div class="row">
                ...
                <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Preencha o seu projeto">
                    
                </div>

                <div class="col-lg-1 col-md-12 col-sm-12 col-xs-12">
                       
                <input type="text" class="form-control" id="titulo" name="titulo" placeholder="B">
                ...
                <input type="text" class="form-control" id="titulo" name="titulo" placeholder="A">
                ...
                <input type="text" class="form-control" id="titulo" name="titulo" placeholder="S">
                ...
                <input type="text" class="form-control" id="titulo" name="titulo" placeholder="I">
                ...
                <div class="col-lg-1 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <input type="text" class="form-control" id="titulo" name="titulo" placeholder="C">
                ...
                <div class="col-lg-1 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <input type="text" class="form-control" id="titulo" name="titulo" placeholder="O">
                ...
                <div class="col-lg-1 col-md-12 col-sm-12 col-xs-12">
                 ...
                 <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Total">
                ...
                <div class="col-lg-1 col-md-12 col-sm-12 col-xs-12">
                   ...
                   <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Média">
                ...
                <button class="btn btn-danger danger-icon-notika"><i class="notika-icon notika-close"></i></button>
