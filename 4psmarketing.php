        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/4Ps do Marketing</li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            <p>Existem conceitos de marketing que não morrem. A internet surgiu, os consumidores mudaram, as transformações se aceleraram, mas os 4 Ps do Marketing continuam sendo um dos principais frameworks do planejamento das estratégias das empresas.</p>
                        </div>
                        <div class="table-responsive"> <a href="criar_4psmarketing.php"> <button type="button" class="btn btn-primary btn-lg">
Nova 4Ps do Marketing</button></a><br><br>
                
                            <table id="data-table-basic" class="table table-striped">
                                <thead>
                                    <tr>
                                        <th>Título da 4Ps do Marketing</th>
                                        <th>Criado em</th>
                                ...
                                <tbody>
                             <?php   $sql3 = "SELECT * FROM `4psmarketing` WHERE (`consultoria_4psmarketing` = '".$consultoria_usuarios."') AND (`empresa_4psmarketing` = '".$EmpresaID."') "; 
    $retorno3 = mysqli_query ($mysqli , $sql3) or die (mysql_error());
    while($dados3 = mysqli_fetch_array($retorno3)){
    $id_4psmarketing = $dados3['id_4psmarketing'];
    $data_4psmarketing = $dados3['data_4psmarketing'];
    $titulo_4psmarketing = $dados3['titulo_4psmarketing'];
   
    ?>
                                    <tr>
                                        <td><div id="espaco"><?php echo $titulo_4psmarketing; ?></div></td>
                                        <td><?php echo date('d/m/Y',  strtotime($data_4psmarketing)); ?></td>
                                      
                                        <td><a href="visualiza_4psmarketing.php?id=<?php echo $id_4psmarketing; ?>"><button type="button" class="btn btn-success btn-sm"  value="Input Button">Visualizar</button>
                                      </a>
                                    </td>
                                        <td><a href="editar_4psmarketing.php?id=<?php echo $id_4psmarketing; ?>"><button type="button" class="btn btn-danger btn-sm">Editar</button></a></td>
                                        <td><a href="apagar_4psmarketing.php?id=<?php echo $id_4psmarketing; ?>"><button type="button" class="btn btn-warning btn-sm">Excluir</button></a></td>
