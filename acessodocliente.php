        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ Acesso do cliente ao Sistema</li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            <p>Segue abaixo Acessos Cadastrados do Cliente no Momento para este processo de Consultoria</p>
                        </div>
                        <div class="table-responsive"> <a href="novoacessocliente.php"> <button type="button" class="btn btn-primary btn-lg">
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th width=180 align="center">Setor:</th>
                                        <th width=180 align="center">Função:</th>
                                ...
                                <?php   
                                          ...
                                          $retorno3 = mysqli_query ($mysqli , $sql3) or die (mysql_error());
                                           while ($lista3 = mysqli_fetch_assoc ($retorno3)) {
                                            ...
                                            $site_usuarios = $lista3['site_usuarios'];
                                            $lattes_usuarios = $lista3['lattes_usuarios'];
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $site_usuarios; ?></td>
                                        <td><?php echo $lattes_usuarios; ?></td>
                                       
                                      
                                        <td><a href="perfil_acessocliente.php?id=<?php echo $id_usuarios; ?>"><button type="button" class="btn btn-success btn-sm" >Visualizar</button></a>
                                      </a>
                                    </td>
                                        <td align=center>
...
if($total === 0)
{ ?>
  <a href="cadastrar_acessodocliente.php?id=<?php echo $id_usuarios; ?>"><button type="button" class="btn btn-success btn-sm">Cadastrar</button></a>
 <?php } else {
?>
<a href="excluir_acessodocliente.php?id=<?php echo $id_usuarios; ?>"><button type="button" class="btn btn-danger btn-sm">Excluir</button></a>
<?php } 
?>
