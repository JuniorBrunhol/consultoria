...
$modelo_contrato = str_replace("\n",'<br />', addslashes(htmlspecialchars($_POST['modelo_contrato'])));
...
$botao2_contrato = str_replace("\n",'<br />', addslashes(htmlspecialchars($_POST['botao2_contrato'])));
$botao3_contrato = str_replace("\n",'<br />', addslashes(htmlspecialchars($_POST['botao3_contrato'])));
$botao4_contrato = str_replace("\n",'<br />', addslashes(htmlspecialchars($_POST['botao4_contrato'])));
$botao5_contrato = str_replace("\n",'<br />', addslashes(htmlspecialchars($_POST['botao5_contrato'])));
$botao6_contrato = str_replace("\n",'<br />', addslashes(htmlspecialchars($_POST['botao6_contrato'])));
$botao7_contrato = str_replace("\n",'<br />', addslashes(htmlspecialchars($_POST['botao7_contrato'])));
$botao8_contrato = str_replace("\n",'<br />', addslashes(htmlspecialchars($_POST['botao8_contrato'])));
$botao9_contrato = str_replace("\n",'<br />', addslashes(htmlspecialchars($_POST['botao9_contrato'])));
$botao10_contrato = str_replace("\n",'<br />', addslashes(htmlspecialchars($_POST['botao10_contrato'])));
$botao11_contrato = str_replace("\n",'<br />', addslashes(htmlspecialchars($_POST['botao11_contrato'])));
$botao12_contrato = str_replace("\n",'<br />', addslashes(htmlspecialchars($_POST['botao12_contrato'])));
$botao13_contrato = str_replace("\n",'<br />', addslashes(htmlspecialchars($_POST['botao13_contrato'])));
$botao14_contrato = str_replace("\n",'<br />', addslashes(htmlspecialchars($_POST['botao14_contrato'])));
$botao15_contrato = str_replace("\n",'<br />', addslashes(htmlspecialchars($_POST['botao15_contrato'])));
...
WHERE id_contrato='$prop'"; 
$resultado_usuario1 = mysqli_query($mysqli, $sql1)or die(mysqli_error($mysqli));
$_SESSION['numero_contrato'] = $prop;
header("Location: visualiza_contrato.php"); exit;
