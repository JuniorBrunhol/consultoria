        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ Cliente / Diagnóstico Empresarial</li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            <p>Todo trabalho de consultoria deve ser antecedido por um diagnóstico empresarial. Esta ferramenta é muito importante para garantir um orçamento adequado diante da demanda da empresa que deseja contratar uma consultoria empresarial.</p>
                        </div>
                        <div class="table-responsive"> <a href="criar_diagprev.php"><button type="button" class="btn btn-primary btn-lg"> Novo Diagnóstico Empresarial</button></a><br><br>
                            ...
                            <table id="data-table-basic" class="table table-striped" width=100%>
                                <thead>
                                    ...
                                    <tr><th width=60%>Diagnósticos emitidos para este cliente</th>
                                ...
                                <tbody>
                         <?php      
                          $sql3 = "SELECT * FROM `diagprev` WHERE (`consultoria_diagprev` = '".$consultoria_usuarios."') AND (`empresa_diagprev` = '".$EmpresaID."') "; 
    $retorno3 = mysqli_query ($mysqli , $sql3) or die (mysql_error());
    while($dados3 = mysqli_fetch_array($retorno3)){
    $id_diagprev = $dados3['id_diagprev'];
    $data_diagprev = $dados3['data_diagprev'];
    $titulo_diagprev = $dados3['titulo_diagprev'];
   
?>
                                    <tr>
                                        <td><div id="espaco"><?php echo $dados3['titulo_diagprev'] ?></div></td>
                                        <td><?php echo date('d/m/Y',  strtotime($data_diagprev)); ?></td>
                                        
                                        <td><a href="visualiza_diagprev.php?id=<?php echo $id_diagprev; ?><button type="button" class="btn btn-success btn-sm"">Visualizar</button>
                             
                                      </a>
                                    </td>
                                  
                                        <td><a href="editar_diagprev.php?id=<?php echo $id_diagprev; ?>"><button type="button" class="btn btn-warning btn-sm"">Editar</button></a></td>
                                        <td><a href="apagar_diagprev.php?id=<?php echo $id_diagprev; ?>"><button type="button" class="btn btn-danger btn-sm">Excluir</button></a></td>
