        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ Matriz Básico</li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Matriz Básico</h2>
                            <p>A Matriz BASICO é um método com foco na priorização de projetos, que visa avaliar uma lista de determinadas possibilidades, conforme 6 critérios que compõem a matriz: benefícios para a organização (B); abrangência dos resultados (A); satisfação interna dos funcionários (S); investimento necessário (I); cliente externo: grau de impacto (C); operacionalização: grau de facilidade (O).</p>
                        </div>
...
{
     location.href = "criar_basico.php";
} 
</script>Novo Matriz Básico</button><br><br>
                
                            <table id="data-table-basic" class="table table-striped">
                                <thead>
                                    <tr>
                                        <th>Título do Matriz Básico</th>
                                        <th>Criado em</th>
                                        <th>Por</th>
...
{
     location.href = "visualiza_swot.php";
} 
</script>
                                      </a>
                                    </td>
