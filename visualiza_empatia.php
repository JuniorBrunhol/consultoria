        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="canvas.php">Mapa da Empatia </a>/ Novo</li>
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Mapa da Empatia</h2>
                    <p>Clique no botão SALVAR para criar o novo documento.</i></p>
									</div>
								</div>
							</div>
							<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
              <form id="form" name="form" method="post" action="gravar_4ps.php">
     					    	
              <button type="button" class="btn btn-warning warning-icon-notika btn-reco-mg btn-button-mg" data-container="body" data-toggle="popover" data-placement="bottom" data-content="O Mapa da Empatia é também uma ferramenta visual que ajuda no exercício de se colocar no lugar de clientes e compreendê-los com mais profundidade por diferentes prismas e faz parte da Metodologia Canvas para Negócios.
Por ser uma ferramenta visual, o mapa ajuda na rápida prototipação, interação entre equipes e no levantamento de hipóteses sobre o público-alvo escolhido.">  <i class="far fa-lightbulb"><font face="arial" size="2">  Ajuda  </font></i></button>
...
{
     location.href = "gravar_canvas.php";
} 
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Coloque um título para seu Mapa da Empatia: 
                            </h2><br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>O QUE O CLIENTE PENSA E SENTE? - O que realmente conta, principais preocupações e aspirações. 
                            </h2><br>
                            <div id="formulario">
                <div class="form-group">
                  
                    <textarea type="text" class="form-control" id="produto" name="produto" rows="10" placeholder="Preencha suas observações aqui."></textarea>
        </div>
            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>O QUE O CLIENTE VÊ? - ambiente, amigos, o que o mercado oferece
                            </h2><br>
                            <div id="formulario">
                <div class="form-group">
                  
                    <textarea type="text" class="form-control" id="preco" name="preco" rows="10" placeholder="Preencha suas observações aqui."></textarea>
        </div>
            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>O QUE O CLIENTE ESCUTA? - O que amigos dizem, o que o chefe fala, o que influenciadores falam. 
                            </h2><br>
                            <div id="formulario">
                <div class="form-group">
                  
                    <textarea type="text" class="form-control" id="praca" name="praca" rows="10" placeholder="Preencha suas observações aqui."></textarea>
        </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>O QUE O CLIENTE FALA E FAZ? - atitudes em público, aparência, comportamento com outros.  
                                </h2>    <br>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="promocao" name="promocao" rows="10" placeholder="Preencha suas observações aqui."></textarea>
        </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>QUAIS SÃO AS DORES DO CLIENTE? - medos, frustrações e obstáculos  
                                </h2>    <br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>QUAIS SÃO OS GANHOS DO CLIENTE? - desejos e necessidades, formas de medir o sucesso, obstáculos 
                                </h2>    <br>
