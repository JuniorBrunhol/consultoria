        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ 8Ps do Marketing Digital</li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            <p>Criados pelo especialista em Marketing Digital Conrado Adolpho, os itens ensinam a coletar dados, planejar uma estratégia de divulgação e tornar a empresa relevante na internet.</p>
                        </div>
                        <div class="table-responsive"> <a href="criar_8psmarketing.php"> <button type="button" class="btn btn-primary btn-lg">
Novo 8Ps do Marketing Digital</button></a><br><br>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                             <?php   $sql3 = "SELECT * FROM `8psmarketing` WHERE (`consultoria_8psmarketing` = '".$consultoria_usuarios."') AND (`empresa_8psmarketing` = '".$EmpresaID."') "; 
    $retorno3 = mysqli_query ($mysqli , $sql3) or die (mysql_error());
    while($dados3 = mysqli_fetch_array($retorno3)){
    $id_8psmarketing = $dados3['id_8psmarketing'];
    $data_8psmarketing = $dados3['data_8psmarketing'];
    $titulo_8psmarketing = $dados3['titulo_8psmarketing'];
   
    ?>
                                    <tr>
                                        <td><div id="espaco"><?php echo $titulo_8psmarketing; ?></div></td>
                                        <td><?php echo date('d/m/Y',  strtotime($data_8psmarketing)); ?></td>
                                      
                                        <td><a href="visualiza_8psmarketing.php?id=<?php echo $id_8psmarketing; ?>"><button type="button" class="btn btn-success btn-sm"  value="Input Button">Visualizar</button>
                                      </a>
                                    </td>
                                        <td><a href="editar_8psmarketing.php?id=<?php echo $id_8psmarketing; ?>"><button type="button" class="btn btn-danger btn-sm">Editar</button></a></td>
                                        <td><a href="apagar_8psmarketing.php?id=<?php echo $id_8psmarketing; ?>"><button type="button" class="btn btn-warning btn-sm">Excluir</button></a></td>
...
<?php  } ?>
                                ...
                                <tfoot>
                                    <tr>
                                        <th>Título do 8ps Marketing Digital</th>
                                        <th>Criado em</th>
