        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ Cliente / Diagnóstico Situacional</li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Diagnóstico Situacional</h2>
                            <p>Diferentemente do Diagnóstico Prévio, neste momento é hora de se aprofundar nos dados para obter o Estado Atual da empresa.</p>
                        </div>
                        <div class="table-responsive"> <a href="criar_diagsituc.php"><button type="button" class="btn btn-primary btn-lg"> Novo Diagnóstico Situacional</button></a><br><br>
                            ...
                            <table id="data-table-basic" class="table table-striped" width=100%>
                                <thead>
                                    ...
                                    <tr><th width=50%>Diagnósticos emitidos para este cliente</th>
                                        <th width=10% align="center">Criado em</th>
                                        <th width=10% align="center">Indicadores</th>
                                ...
                                <tbody>
                         <?php      
                          $sql3 = "SELECT * FROM `diagnosticosituacional` WHERE (`consultoria_diagnosticosituacional` = '".$consultoria_usuarios."') AND (`empresa_diagnosticosituacional` = '".$EmpresaID."') "; 
    $retorno3 = mysqli_query ($mysqli , $sql3) or die (mysql_error());
    while($dados3 = mysqli_fetch_array($retorno3)){
    $id_diagnosticosituacional = $dados3['id_diagnosticosituacional'];
    $dataregistro_diagnosticosituacional = $dados3['dataregistro_diagnosticosituacional'];
    $titulo_diagnosticosituacional = $dados3['titulo_diagnosticosituacional'];
   
?>
                                    <tr>
                                        <td><div id="espaco"><?php echo $dados3['titulo_diagnosticosituacional'] ?></div></td>
                                        <td><?php echo date('d/m/Y',  strtotime($dataregistro_diagnosticosituacional)); ?></td>
                                        <td><a href="indicadores_diagnosticosituacional.php?id=<?php echo $id_diagnosticosituacional; ?><button type="button" class="btn btn-success btn-sm"">Indicadores</button>
                             
                             </a>
                       
                                        <td><a href="visualiza_diagnosticosituacional.php?id=<?php echo $id_diagnosticosituacional; ?><button type="button" class="btn btn-success btn-sm"">Visualizar</button>
                             
                                      </a>
                                    </td>
                                  
                                        <td><a href="editar_diagnosticosituacional.php?id=<?php echo $id_diagnosticosituacional; ?>"><button type="button" class="btn btn-warning btn-sm"">Editar</button></a></td>
                                        <td><a href="apagar_diagnosticosituacional.php?id=<?php echo $id_diagnosticosituacional; ?>"><button type="button" class="btn btn-danger btn-sm">Excluir</button></a></td>
                                ...
                                <tfoot>
                                    <tr>
                                        <th>Diagnósticos emitidos para este cliente</th>
