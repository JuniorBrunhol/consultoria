...
<div class="subnavbar">
  ...
  <!-- /subnavbar-inner --> 
    ...
    <div class="sale-statistic-area">
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/  Clientes / <a href="rafc.php">RAFC - Registro de Atendimento Fora do Cliente</a>/ Novo</li>
         ...
         <form id="form" name="form" method="post" action="gravar_rafc.php">  
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                       ...
                       <div class="row">
                                    ...
                                    <input type="text" class="form-control" id="datainicio_rafc" oninput="mascara(this, 'nascimento')" name="datainicio_rafc"  required placeholder="Preencha a data inicial" value="<?php echo $datahoje; ?>"><br>
                                    ...
                                    <input type="text" class="form-control" id="horarioinicio_rafc" oninput="mascara(this, 'hora')" name="horarioinicio_rafc"  required placeholder="Preencha o horário inicial" value="00:00:00"><br>
       ...
       <div class="row">
                                    ...
                                    <input type="text" class="form-control" id="datatermino_rafc" oninput="mascara(this, 'nascimento')" name="datatermino_rafc"  required placeholder="Preencha a data do término" value="<?php echo $datahoje; ?>"><br>
                                    ...
                                    <input type="text" class="form-control" id="horariotermino_rafc" oninput="mascara(this, 'hora')" name="horariotermino_rafc"  required placeholder="Preencha o horário do término" value="00:00:00"><br>
       ...
       <div class="row">
                                    ...
                                    <input type="text" class="form-control" id="local_rafc" name="local_rafc"  required placeholder="Local da reunião"><br>
                                    ...
                                    <input type="text" class="form-control" id="area_rafc" name="area_rafc"  required placeholder="Setor da Empresa"><br>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="hrzn-fm">ASSUNTO:</label>
                                    </div>
                                    <div class="col-lg-9 col-md-7 col-sm-7 col-xs-12">
                                    
                                    <input type="text" class="form-control" id="assunto_rafc" name="assunto_rafc"  required placeholder="Qual o assunto da reunião?">
                                ...
                                <div class="row">
                                    ...
                                    <textarea type="text" class="form-control" id="participantes_rafc" name="participantes_rafc" rows="3"  required placeholder="Quais são as pessoas que participaram desta reunião"></textarea>
  ...
  <div class="row">
                                    ...
                                    <textarea type="text" class="form-control" id="resumo_rafc" name="resumo_rafc" rows="6"  required placeholder="Escreva um breve resumo de tudo o que aconteceu durante a reunião"></textarea>
                                    <br><br>
                                         
                           
                                      
                                         <a href="gravar_rafc.php"><button class="btn btn-success success-icon-notika btn-reco-mg btn-button-mg">
