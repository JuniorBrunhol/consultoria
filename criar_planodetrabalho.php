        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="planodetrabalho.php">Plano de Trabalho </a>/ Novo</li>
              ...
              <form id="form" name="form" method="post" action="gravar_cronograma.php">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
           ...
           <h2>PLANO DE TRABALHO</h2><BR>
                  ...
                  <div class="input-group">
                    ...
                    <div class="nk-int-st">
                    <input type="text" class="form-control" id="titulo_cronograma" name="titulo_cronograma" placeholder="Preencha um título para identificar seu Plano de Trabalho"><br>
                    </div>
                  </div>
                  <br>
                  ...
                  <div class="input-group">
                    ...
                    <div class="nk-int-st">
                    <input type="text" class="form-control" id="datainicial_cronograma" oninput="mascara(this, 'nascimento')" name="datainicial_cronograma"  required placeholder="Preencha a data inicial"><br>
                    </div>
                    <span class="input-group-addon nk-ic-st-pro">PREVISÃO TÉRMINO:</span> 
                    <div class="nk-int-st">
                    <input type="text" class="form-control" id="previsaofim_cronograma" oninput="mascara(this, 'nascimento')" name="previsaofim_cronograma"  required placeholder="Preencha a data inicial"><br>
                   </div>
                  </div>
                  <br>
                  ...
                  <div class="input-group">
                    ...
                    <div class="nk-int-st">
                    <textarea type="text" class="form-control" id="objetivo_cronograma" name="objetivo_cronograma" rows="6"  required placeholder="Descreva como foi o andamento das ações deixadas. Quais andaram e quais não."></textarea>
                    </div>
                  </div>

                  <div class="input-group">
                    <br><br>
                    <a href="gravar_cronograma.php"><button class="btn btn-success success-icon-notika btn-reco-mg btn-button-mg"><i class="notika-icon notika-checked"><font face="arial" size="2">  Salvar  </font></i></button></a>
