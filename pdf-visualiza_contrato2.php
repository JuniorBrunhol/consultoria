...
include_once 'conexao/conexao.php';
  ...
  $html .= '<div><h2><strong>'.$titulotopo_contrato. "</strong></h2>";
  if ($botao1_contrato == '.on.') { 
  $html .= '<div><br><strong><font size=5>'.$cl1titulo_contrato. "</font></strong><br>";
  $html .= '<div><font size=3>'.$texto1_contrato. "</font>";
  }
  if ($botao2_contrato == '.on.') { 
    $html .= '<div><br><strong><font size=5>'.$cl2titulo_contrato. "</font></strong><br>";
    $html .= '<div><font size=3>'.$texto2_contrato. "</font>";
    }
    if ($botao3_contrato == '.on.') { 
      $html .= '<div><br><strong><font size=5>'.$cl3titulo_contrato. "</font></strong><br>";
      $html .= '<div><font size=3>'.$texto3_contrato. "</font>";
      }
      if ($botao4_contrato == '.on.') { 
        $html .= '<div><br><strong><font size=5>'.$cl4titulo_contrato. "</font></strong><br>";
        $html .= '<div><font size=3>'.$texto4_contrato. "</font>";
        }
        if ($botao5_contrato == '.on.') { 
          $html .= '<div><br><strong><font size=5>'.$cl5titulo_contrato. "</font></strong><br>";
          $html .= '<div><font size=3>'.$texto5_contrato. "</font>";
          }
          if ($botao6_contrato == '.on.') { 
            $html .= '<div><br><strong><font size=5>'.$cl6titulo_contrato. "</font></strong><br>";
            $html .= '<div><font size=3>'.$texto6_contrato. "</font>";
            }
            if ($botao7_contrato == '.on.') { 
              $html .= '<div><br><strong><font size=5>'.$cl7titulo_contrato. "</font></strong><br>";
              $html .= '<div><font size=3>'.$texto7_contrato. "</font>";
              }
              if ($botao8_contrato == '.on.') { 
                $html .= '<div><br><strong><font size=5>'.$cl8titulo_contrato. "</font></strong><br>";
                $html .= '<div><font size=3>'.$texto8_contrato. "</font>";
                }
                if ($botao9_contrato == '.on.') { 
                  $html .= '<div><br><strong><font size=5>'.$cl9titulo_contrato. "</font></strong><br>";
                  $html .= '<div><font size=3>'.$texto9_contrato. "</font>";
                  }
                  if ($botao10_contrato == '.on.') { 
                    $html .= '<div><br><strong><font size=5>'.$cl10titulo_contrato. "</font></strong><br>";
                    $html .= '<div><font size=3>'.$texto10_contrato. "</font>";
                    }
                    if ($botao11_contrato == '.on.') { 
                      $html .= '<div><br><strong><font size=5>'.$cl11titulo_contrato. "</font></strong><br>";
                      $html .= '<div><font size=3>'.$texto11_contrato. "</font>";
                      }
                      if ($botao12_contrato == '.on.') { 
                        $html .= '<div><br><strong><font size=5>'.$cl12titulo_contrato. "</font></strong><br>";
                        $html .= '<div><font size=3>'.$texto12_contrato. "</font>";
                        }
                        if ($botao13_contrato == '.on.') { 
                          $html .= '<div><br><strong><font size=5>'.$cl13titulo_contrato. "</font></strong><br>";
                          $html .= '<div><font size=3>'.$texto13_contrato. "</font>";
                          }
                          if ($botao14_contrato == '.on.') { 
                            $html .= '<div><br><strong><font size=5>'.$cl14titulo_contrato. "</font></strong><br>";
                            $html .= '<div><font size=3>'.$texto14_contrato. "</font>";
                            }
                            if ($botao15_contrato == '.on.') { 
                              $html .= '<div><br><strong><font size=5>'.$cl15titulo_contrato. "</font></strong><br>";
                              $html .= '<div><font size=3>'.$texto15_contrato. "</font>";
                              }
