...
if(!empty($id)){
	$result_usuario = "DELETE FROM acesso_empresa WHERE usuarios_acesso_empresa='$id' AND consultoria_acesso_empresa='$consultoria_usuarios' AND empresa_acesso_empresa='$EmpresaID'";
	$resultado_usuario = mysqli_query($mysqli, $result_usuario);
	if(mysqli_affected_rows($mysqli)){
		$_SESSION['msg'] = "<p style='color:green;'>Registro deletado com sucesso</p>";
		header("Location: acessodocliente.php");
	}else{
