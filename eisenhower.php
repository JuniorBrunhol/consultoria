        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ Matriz Eisenhower</li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            <p>Matriz de Eisenhower ou Princípio da Decisão de Eisenhower é uma ferramenta de Gerenciamento de tempo que tem esse nome em homenagem a Dwight D. Eisenhower, já que ela foi criada após uma citação dita por ele: "Tenho dois tipos de problemas, o urgente e o importante. Os urgentes não são importantes, e os importantes nunca são urgentes." Eisenhower não reivindica essa visão por conta própria, mas atribui-a a um (sem citar nome) "ex-presidente de faculdade". A matriz, que tem como finalidade a organização de uma rotina, através da priorização de tarefas de acordo com seu grau de urgência e importância[3], foi criada por Stephen Covey, em seu livro “Os 7 Hábitos das Pessoas Altamente Eficazes”.</p>
                        </div>
                        <div class="table-responsive"> <a href="criar_eisenhower.php"> <button type="button" class="btn btn-primary btn-lg">
Nova Matriz Eisenhower</button></a><br><br>
                
                            <table id="data-table-basic" class="table table-striped">
                                <thead>
                                    <tr>
                                        <th>Título da Matriz de Eisenhower</th>
                                        <th>Criado em</th>
                                ...
                                <tbody>
                             <?php   $sql3 = "SELECT * FROM `eisenhower` WHERE (`consultoria_eisenhower` = '".$consultoria_usuarios."') AND (`empresa_eisenhower` = '".$EmpresaID."') "; 
    $retorno3 = mysqli_query ($mysqli , $sql3) or die (mysql_error());
    while($dados3 = mysqli_fetch_array($retorno3)){
    $id_eisenhower = $dados3['id_eisenhower'];
    $data_eisenhower = $dados3['data_eisenhower'];
    $titulo_eisenhower = $dados3['titulo_eisenhower'];
   
    ?>
                                    <tr>
                                        <td><div id="espaco"><?php echo $titulo_eisenhower; ?></div></td>
                                        <td><?php echo date('d/m/Y',  strtotime($data_eisenhower)); ?></td>
                                      
                                        <td><a href="visualiza_eisenhower.php?id=<?php echo $id_eisenhower; ?>"><button type="button" class="btn btn-success btn-sm"  value="Input Button">Visualizar</button>
                                      </a>
                                    </td>
                                        <td><a href="editar_eisenhower.php?id=<?php echo $id_eisenhower; ?>"><button type="button" class="btn btn-danger btn-sm">Editar</button></a></td>
                                        <td><a href="apagar_eisenhower.php?id=<?php echo $id_eisenhower; ?>"><button type="button" class="btn btn-warning btn-sm">Excluir</button></a></td>
...
<?php  } ?>
                                ...
                                <tfoot>
                                    <tr>
                                        <th>Título da Matriz Eisenhower</th>
                                        <th>Criado em</th>
