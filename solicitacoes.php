...
?>
  ...
  <div class="container">
    ...
    <p>Sr(a),<b> <?php echo $_SESSION['UsuarioNome']; ?>,</b> segue abaixo as últimas atualizações de melhoria no sistema que foram realizadas.</p>
         ...
         <form action="gravar_solicitacao.php" method="POST" enctype="multipart/form-data">
                    <div class="form-example-wrap mg-t-30">
                        ...
                        <div class="form-example-int form-horizental">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon nk-ic-st-pro">TITULO DA SOLICITAÇÃO:</span>
                                    <div class="nk-int-st">
                                    
                                        <input type="text" class="form-control" id="titulo" minlength="10" maxlength="195" name="titulo" placeholder="Preencha com a Razão Social">
                        ...
                        <div class="form-example-int form-horizental">
                            <div class="form-group">
                                <div class="row">
                                <div class="input-group">
                                    <span class="input-group-addon nk-ic-st-pro">SUGESTÃO / SOLICITAÇÃO:</span>
                                    <div class="nk-int-st">
                        ...
                        <div class="form-example-int form-horizental">
                            <div class="form-group">
                              ...
                              <BR><bR>
                                ...
                                <A HREF="gravar_solicitacao.php"><button type="submit" class="btn btn-success success-icon-notika btn-reco-mg btn-button-mg" value="Input Button" onclick=" relocate_home()">
                            ...
                            <table id="data-table-basic" class="table table-striped" width=100%>
                                <thead>
                                    ...
                                    <tr><th width=50%>Solicitação</th>
                                        ...
                                        <th width=10% align="center">Previsão</th>
...
$sql = "SELECT * FROM `solicitacao` WHERE (`usuario_solicitacao` = '".$idconsultor."')"; 
...
?>      <tr>
                                        ...
                                        <td><?php echo date('d/m/Y',  strtotime($previsao)); ?></td>
                                        <td>
