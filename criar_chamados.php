...
<head>
    ...
    <link rel="stylesheet" href="chamados/dist/ui/trumbowyg.min.css">
    <link rel="stylesheet" href="chamados/dist/plugins/emoji/ui/trumbowyg.emoji.min.css">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="chamados.php">Chamados </a>/ Novo</li>
	...
	<div class="breadcomb-area">
		<div class="container">
			<div class="row">
              ...
              <form id="form" name="form" method="post" action="gravar_chamados.php">
              <div class="col-lg-1 col-md-3 col-sm-3 col-xs-12">
                                    ...
                                    <div class="col-lg-1 col-md-3 col-sm-3 col-xs-12">
                                        <label class="hrzn-fm">PARA:</label>
                                    </div>
                                    <div class="col-lg-5 col-md-7 col-sm-7 col-xs-12">
                                     
                                  
                                    <select class="form-control" data-placeholder="Para quem é direcionado a solicitação?" id="direcionamento_chamado" name="direcionamento_chamado">
                                    <?php 
      $sql2 = "SELECT * FROM `acesso_empresa` WHERE (`empresa_acesso_empresa` = '".$EmpresaID."') AND  (`consultoria_acesso_empresa` = '".$consultoria_usuarios."') "; 
      $retorno2 = mysqli_query ($mysqli , $sql2) or die (mysql_error());
      while($dados2 = mysqli_fetch_array($retorno2)){
        $idconsultausuario = $dados2['usuarios_acesso_empresa'];
          ?>
                                    <option value="<?php echo $dados2['usuarios_acesso_empresa']; ?>">
                                    <?PHP 
          $sql4 = "SELECT * FROM `usuarios` WHERE (`id_usuarios` = '".$idconsultausuario."') ORDER BY nome_usuarios"; 
    $retorno4 = mysqli_query ($mysqli , $sql4) or die (mysql_error());
      while ($lista4 = mysqli_fetch_array ($retorno4)) {
        
          $nome_usuarios = $lista4['nome_usuarios'];
           ...
           echo $nome_usuarios;  } ?>
              ...
              <div class="data-table-list">
              <div class="basic-tb-hd">
              <label class="hrzn-fm"><BR>SOLICITAÇÃO:</label><br>
                            <div id="formulario">
                <div class="form-group">
                  
                    <textarea class="form-control" name="texto_chamado" id="texto_chamado" rows="10" ></textarea>
                    <br><br> 
                                         <a href="gravar_chamados.php" ><button class="btn btn-success success-icon-notika btn-reco-mg btn-button-mg">
         
        <i class="notika-icon notika-checked"><font face="arial" size="2">  Salvar  </font></i></button></a>
        </form>                                  <a href="chamados.php"> <button class="btn btn-danger danger-icon-notika btn-reco-mg btn-button-mg">
...
<script src="chamados/dist/trumbowyg.min.js"></script>

<script type="text/javascript" src="chamados/dist/langs/pt_br.min.js"></script>

<script src="chamados/dist/plugins/emoji/trumbowyg.emoji.min.js"></script>
