...
include_once 'conexao/conexao.php';
  ...
  $sql = "SELECT * FROM `porter` WHERE (`id_porter` =  '".$id."') "; 
  $retorno = mysqli_query ($mysqli , $sql) or die (mysql_error());
   while ($lista = mysqli_fetch_assoc ($retorno)) {
    $id_porter = $lista['id_porter'];
    $titulo_porter = $lista['titulo_porter'];
    $entrantes_porter = str_replace('<br />', "\n", $lista['entrantes_porter']);
    $acaoentrantes_porter = str_replace('<br />', "\n", $lista['acaoentrantes_porter']);
    $negociacao_porter = str_replace('<br />', "\n", $lista['negociacao_porter']);
    $acaonegociacao_porter = str_replace('<br />', "\n", $lista['acaonegociacao_porter']);
    $concorrencia_porter = str_replace('<br />', "\n", $lista['concorrencia_porter']);
    $acaoconcorrencia_porter = str_replace('<br />', "\n", $lista['acaoconcorrencia_porter']);
    $barganha_porter = str_replace('<br />', "\n", $lista['barganha_porter']);
    $acaobarganha_porter = str_replace('<br />', "\n", $lista['acaobarganha_porter']);
    $produto_porter = str_replace('<br />', "\n", $lista['produto_porter']);
    $acaoproduto_porter = str_replace('<br />', "\n", $lista['acaoproduto_porter']);
    $resumo_porter = str_replace('<br />', "\n", $lista['resumo_porter']);
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="porter.php">5 Forças de Porter </a>/ Editar</li>
	...
	<div class="breadcomb-area">
		<div class="container">
			<div class="row">
              ...
              <form id="form" name="form" method="post" action="gravaredicao_porter.php">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            ...
                            <input type="hidden" class="form-control" id="id_porter" name="id_porter"  value="<?php echo $id_porter; ?>"><br>
   
                    <input type="text" class="form-control" id="titulo_porter" name="titulo_porter" placeholder="Preencha um título para identificar sua ferramenta de 5 Forças de Porter" value="<?php echo $titulo_porter; ?>"><br>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="acaoentrantes_porter" name="acaoentrantes_porter" rows="10" placeholder=""><?php echo $acaoentrantes_porter; ?></textarea>
        </div>
            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="negociacao_porter" name="negociacao_porter" rows="10" placeholder="Também descrito como mercado de insumos. Fornecedores de matérias-primas, componentes e serviços para a empresa pode ser uma fonte de poder. Fornecedores podem recusar-se a trabalhar com a empresa, ou por exemplo, cobrar preços excessivamente elevados para recursos únicos."><?php echo $negociacao_porter; ?></textarea>
        </div>
            </div>
                        </div>
                        <div class="basic-tb-hd">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="acaonegociacao_porter" name="acaonegociacao_porter" rows="10" placeholder=""><?php echo $acaonegociacao_porter; ?></textarea>
        </div>
            </div>
                        </div>
...
Em situações de elevada rivalidade os concorrentes procuram ativamente captar clientes, as margens são esmagadas e a atuação centra-se em cortes de preços e descontos de quantidade. Lembrando que esse sistema é feito para servir pessoas e como consequência vem os lucros."><?php echo $concorrencia_porter; ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="acaoconcorrencia_porter" name="acaoconcorrencia_porter" rows="10" placeholder=""><?php echo $acaoconcorrencia_porter; ?></textarea>
        </div>
            </div>
                        </div>
...
Da sua capacidade de integração a montante"><?php echo $barganha_porter; ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="acaobarganha_porter" name="acaobarganha_porter" rows="10" placeholder=""><?php echo $acaobarganha_porter; ?></textarea>
        </div>
            </div>
                        </div>
                    </div>
...
A “ameaça” da concorrência é informada pela troca de custos, tanto imediatos quanto a longo prazo, considerando também a inclinação do comprador para realizar mudanças."><?php echo $produto_porter; ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="acaoproduto_porter" name="acaoproduto_porter" rows="10" placeholder=""><?php echo $acaoproduto_porter; ?></textarea>
        </div>
            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                      ...
                      <textarea type="text" class="form-control" id="resumo_porter" name="resumo_porter" rows="5" placeholder="Observações do Consultor"><?php echo $resumo_porter; ?></textarea>
                      <br><br> 
                                         <a href="gravaredicao_porter.php"><button class="btn btn-success success-icon-notika btn-reco-mg btn-button-mg">
