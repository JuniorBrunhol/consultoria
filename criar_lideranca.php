        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-info" role="alert">
                        <ul>
                            <li><a href="index.php">Home </a>/ <a href="lideranca.php">Matriz de Liderança </a>/ Novo</li>
...
{
     location.href = "gravar_lideranca.php";
} 
